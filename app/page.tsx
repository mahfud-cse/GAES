...
const builderSeed: BuilderItem[] = [
  ...
  },
  {
    id: "menu-access",
    surface: "Main Navigation",
    labelId: "Lounge/Tenant Access",
    labelEn: "Lounge/Tenant Access",
    kind: "Menu",
    visible: true,
    required: true,
    locked: true,
  },
  {
    id: "menu-visitor",
    surface: "Main Navigation",
    labelId: "Visitor & Reconciliation",
    labelEn: "Visitor & Reconciliation",
    kind: "Menu",
    visible: true,
    required: true,
    locked: true,
  },
  {
    id: "menu-flight",
    surface: "Main Navigation",
    labelId: "Flight Information",
    labelEn: "Flight Information",
    kind: "Menu",
    visible: true,
    required: true,
    locked: true,
  ...
  {
    id: "field-dot",
    surface: "Lounge/Tenant Access",
    labelId: "Date of Travel",
    labelEn: "Date of Travel",
    kind: "Date",
    visible: true,
    required: true,
    locked: true,
  },
  {
    id: "field-passenger",
    surface: "Lounge/Tenant Access",
    labelId: "Nama Penumpang",
    labelEn: "Passenger Name",
    kind: "Text",
    visible: true,
    required: true,
    locked: true,
  ...
  {
    id: "column-ffp",
    surface: "Verifier Review",
    labelId: "Nomor FFP/Membership",
    labelEn: "FFP/Membership Number",
    kind: "Text",
    visible: true,
    required: false,
    locked: true,
...
const interfaceTranslations: Record<string, string> = {
  ...
  "Kata Sandi": "Password",
  "Gunakan Input Manual": "Use Manual Input",
  "Mulai Scan Camera": "Start Camera Scan",
  "Aktifkan Device Scanner": "Activate Device Scanner",
  "Langkah 1": "Step 1",
  "Langkah 2–3": "Steps 2–3",
  "Preview & Konfirmasi": "Preview & Confirmation",
  "Nama Penumpang": "Passenger Name",
  "Nomor Penerbangan": "Flight Number",
  "Kelas Kabin": "Cabin Class",
  "Pilih kelas": "Select class",
  "Pilih lounge": "Select lounge",
  "Simpan & Konfirmasi": "Save & Confirm",
  Batal: "Cancel",
  Tutup: "Close",
  Ubah: "Update",
  Hapus: "Delete",
  ...
  Proses: "Process",
  Semua: "All",
  "Semua Station": "All Stations",
  "Semua Airport": "All Airports",
  "Semua Status": "All Status",
  "Tidak ada pilihan yang sesuai": "No matching options",
  "data ditemukan": "records found",
  ...
  "Jumlah Pendamping": "Companion Count",
  "Kategori Pendamping": "Companion Category",
  ...
  "Kelola Laporan": "Manage Report",
  "Kelola Tabel": "Manage Table",
  "Judul Laporan": "Report Title",
  "Template Nama File": "File Name Template",
  "Informasi di Atas Tabel": "Information Above Table",
  "Kolom Tabel": "Table Columns",
  "Nama Kolom": "Column Name",
  "Tipe Data": "Data Type",
  "Field Formula": "Formula Field",
  "Tambah Field": "Add Field",
  "Tambah Operator": "Add Operator",
  "Tambah Fungsi": "Add Function",
  "Bersihkan Formula": "Clear Formula",
  Preview: "Preview",
  "Belum ada custom column.": "No custom columns yet.",
  "Kolom Inti Sistem": "Core System Fields",
  Aktif: "Active",
  Nonaktif: "Inactive",
  Diterima: "Accepted",
  Ditolak: "Rejected",
  Menunggu: "Pending",
  "Kirim Ulang ke Verifier": "Resubmit to Verifier",
  "Konfirmasi dan Kirim Evidence": "Confirm and Submit Evidence",
  "Lampiran evidence": "Evidence attachment",
  "Alasan Penolakan": "Rejection Reason",
  "Ganti bahasa": "Change language",
  "Daftar Lounge/Tenant": "Lounge/Tenant List",
  "Data referensi dan rule operasional sesuai kewenangan pengguna.":
    "Reference data and operational rules based on user authority.",
  "Data Kunjungan": "Visitor Data",
  "Aktifkan Filter": "Activate Filter",
  "Filter Aktif": "Filter Active",
  "Periode mulai": "Start period",
  "Periode akhir": "End period",
  "Jam mulai": "Start time",
  "Jam akhir": "End time",
  "Rata-rata/jam": "Average/hour",
  "seluruh Branch Office": "all Branch Offices",
  "Total Biaya": "Total Cost",
  "Kategori penumpang": "Passenger Category",
  "Status visitor": "Visitor Status",
  "Nama / flight / lounge": "Name / flight / lounge",
  Penumpang: "Passenger",
  Rute: "Route",
  Pembaruan: "Updated",
  Kategori: "Category",
  ...
  "Kosongkan Data Uji": "Clear Test Data",
  "Hak pengelolaan": "Management Authority",
  "Tambah Lounge": "Add Lounge",
  "Tambah User": "Add User",
  "Simpan & Terapkan Rule": "Save & Apply Rule",
  "Rule efektif": "Effective Rule",
  "Referensi Waktu": "Time Reference",
  "Waktu transaksi mengikuti station aktif. Pilih Date of Travel sebelum scan agar flight schedule yang diperiksa tepat.":
    "Transaction time follows the active station. Select Date of Travel before scanning to confirm the correct flight schedule.",
  Berhasil: "Success",
  Perhatian: "Attention",
  "Tidak dapat diproses": "Cannot be processed",
  "Ya, Hapus Data": "Yes, Delete Data",
  "Tambah & Konfirmasi": "Add & Confirm",
  "Belum diverifikasi": "Not verified",
  Kedaluwarsa: "Expired",
  "hari tersisa": "days remaining",
  "OPERASIONAL AKSES": "OPERATIONAL ACCESS",
  "Scan boarding pass atau gunakan fallback input manual saat scanner terkendala.":
    "Scan the boarding pass or use manual input if the scanner is unavailable.",
  "Pilih DOT & Baca Boarding Pass": "Select DOT & Scan Boarding Pass",
  Siap: "Ready",
  "Pilih tanggal penerbangan sebelum memulai scan.":
    "Select the Date of Travel before starting the scan.",
  "MENUNGGU SCAN": "WAITING FOR SCAN",
  "TIDAK ELIGIBLE": "NOT ELIGIBLE",
  "Nama sesuai boarding pass": "Name as shown on the boarding pass",
  "Kamera belum aktif": "Camera is not active",
  "Posisikan kode di dalam bingkai": "Position the code inside the frame",
  "Hentikan Kamera": "Stop Camera",
  "Device Scanner Aktif": "Device Scanner Active",
  "ATAU INPUT STRING": "OR ENTER STRING",
  "Hasil scan / string boarding pass": "Scanned result / boarding pass string",
  "Baca String dan Tampilkan Data": "Read String and Display Data",
  "Scanner atau barcode bermasalah?": "Scanner or barcode unavailable?",
  "Data yang ditolak BO dikembalikan kepada petugas lounge.":
    "Rejected data is returned to the Lounge Officer for correction.",
  "Belum ada data dispute.": "No dispute data.",
  "Menunggu Respons Lounge": "Waiting for Lounge Response",
  "Menunggu koreksi petugas lounge": "Waiting for correction by Lounge Officer",
  "Total hanya menghitung visitor Accepted sesuai filter aktif.":
    "Total includes only Accepted visitors within the active filters.",
  "Verifikasi, dispute, rekonsiliasi, laporan, dan sign-off BO–Vendor dalam satu proses.":
    "Verification, dispute, reconciliation, reporting, and BO–Vendor sign-off in one process.",
  "Pilih per pax atau sekaligus, kemudian tentukan diterima atau ditolak.":
    "Select passengers individually or in bulk, then accept or reject them.",
  "Traffic per jam, Date of Travel, status rekonsiliasi, dan biaya sesuai kewenangan akun.":
    "Hourly traffic, Date of Travel, reconciliation status, and cost based on account authority.",
  Terima: "Accept",
  "LANGKAH 1": "STEP 1",
  "LANGKAH 2–3": "STEPS 2–3",
...
type IntegrationStatus = {
  ...
  name: string;
  mode: "Mock" | "Live";
  status: "Ready" | "Attention" | "Not Connected";
  lastSync: string;
  dataOwner: string;
...
const partnershipSeed: Partnership[] = [
  {
    id: "p0",
    type: "Membership",
    name: "GarudaMiles Platinum",
    reference: "API membership / verifikasi HO Ancillary",
    status: "Aktif",
    allowedRoles: [
      "Super Admin",
      "Admin",
    ...
    verifierOrganization: "HO Ancillary",
    eligibleTiers: "Platinum",
    effectiveStart: "2026-01-01",
    effectiveEnd: "2027-12-31",
    stationScope: "ALL",
    payer: "Garuda Indonesia",
    priceRule: "Lounge unit price",
    companionRule: "1 companion; linked to Parent Visitor ID",
    apiReferenceFields: "memberNumber,tier,status",
    version: 1,
  },
  {
    id: "p1",
    type: "Partnership",
    name: "Kerjasama MPA",
    reference: "Nomor agreement wajib",
    status: "Aktif",
    allowedRoles: [
      "Super Admin",
      "Admin",
    ...
    verifierOrganization: "Designated Airline Representative",
    eligibleTiers: "As agreement",
    effectiveStart: "2026-01-01",
    effectiveEnd: "2027-12-31",
    stationScope: "Configured stations",
    payer: "Partner Airline",
    priceRule: "Agreement price",
    companionRule: "As agreement",
    apiReferenceFields: "agreementNumber,passengerStatus",
    version: 1,
  },
  {
    id: "p2",
    type: "EMD",
    name: "EMD Lounge Access",
    reference: "Validasi dan redemption coupon",
    status: "Aktif",
    allowedRoles: [
      "Super Admin",
      "Admin",
    ...
    verifierOrganization: "HO Ancillary",
    eligibleTiers: "Valid coupon",
    effectiveStart: "2026-01-01",
    effectiveEnd: "2027-12-31",
    stationScope: "ALL",
    payer: "Passenger/Issuer",
    priceRule: "EMD amount",
    companionRule: "Not included",
    apiReferenceFields: "emdNumber,couponStatus,amount",
    version: 1,
  },
  {
    id: "p3",
    type: "Paid Access",
    name: "Paid Access",
    reference: "Menunggu payment integration",
    status: "Nonaktif",
    allowedRoles: [
      "Super Admin",
      "Admin",
    ...
    stationScope: "Configured stations",
    payer: "Passenger",
    priceRule: "Published price",
    companionRule: "Separate purchase",
    apiReferenceFields: "paymentId,paymentStatus,amount",
    version: 1,
  },
];
const roleProfileSeed: RoleProfile[] = [
  {
    ...
    scope: "All organizations, stations, programs",
  },
  {
    role: "Admin",
    permissions: [
    ...
    scope: "Operational configuration; approve reopen",
  },
  {
    role: "HO Admin",
    permissions: ["View", "Download"],
    scope: "All stations; monitoring",
  },
  {
    role: "BO Admin",
    permissions: ["View", "Add", "Edit", "Verify", "Download"],
    scope: "Assigned station; Business Class and VIP/CIP/VVIP",
  },
  {
    role: "Lounge Officer",
    permissions: ["View", "Add", "Edit", "Download"],
    scope: "Assigned lounge; input and evidence",
  },
  {
    role: "Lounge Manager",
    permissions: ["View", "Verify", "Download"],
    scope: "Assigned lounge; exceptional access",
  },
  {
    role: "HO Ancillary Coordinator",
    permissions: ["View", "Edit", "Download", "Manage"],
    scope: "HO Ancillary products",
  },
  {
    role: "HO Ancillary Verifier",
    permissions: ["View", "Verify", "Download"],
    scope: "GarudaMiles, EMD and Paid Access",
  },
  {
    role: "Airline Coordinator",
    permissions: ["View", "Edit", "Download", "Manage"],
    scope: "Assigned airline/program",
  },
  {
    role: "Airline Verifier",
    permissions: ["View", "Verify", "Download"],
    scope: "Assigned airline passengers only",
  },
  {
    role: "Report Viewer",
    permissions: ["View", "Download"],
    scope: "Configured reports only",
  },
];
const integrationSeed: IntegrationStatus[] = [
  {
    ...
    lastSync: "—",
    dataOwner: "Flight Operations",
    technicalOwner: "IT Integration",
    fallback: "CSV/XLSX import + manual flight",
  },
  {
    id: "pax",
    name: "Passenger List / DCS",
    mode: "Mock",
    status: "Not Connected",
    lastSync: "—",
    dataOwner: "Airport Operations",
    technicalOwner: "IT Integration",
    fallback: "Mapped CSV/XLSX import with preview",
  },
  {
    id: "gm",
    name: "GarudaMiles Membership",
    mode: "Mock",
    status: "Ready",
    lastSync: "Simulation",
    dataOwner: "HO Ancillary",
    technicalOwner: "IT Integration",
    fallback: "Manual verification + evidence",
  },
  {
    id: "emd",
    name: "EMD Lounge",
    ...
    dataOwner: "HO Ancillary",
    technicalOwner: "IT Integration",
    fallback: "Manual EMD verification",
  },
  {
    id: "partner",
    name: "Partner Airline / SkyTeam",
    mode: "Mock",
    status: "Attention",
    lastSync: "Simulation",
    dataOwner: "Partner Airline",
    technicalOwner: "IT Integration",
    fallback: "Scoped airline verifier",
  },
  {
    id: "payment",
    name: "Paid Access Payment",
    mode: "Mock",
    status: "Not Connected",
    lastSync: "—",
    dataOwner: "Commercial",
    technicalOwner: "IT Integration",
    fallback: "Receipt evidence",
  },
  {
    id: "evidence",
    ...
    mode: "Mock",
    status: "Ready",
    lastSync: "Local prototype",
    dataOwner: "Operations",
    technicalOwner: "IT Infrastructure",
    fallback: "Metadata-only prototype",
  },
  {
    id: "notification",
...
const airlineSeed: Airline[] = [
  {
    ...
    verifierOrganization: "Garuda Indonesia",
    status: "Active",
  },
  {
    code: "KE",
    name: "Korean Air",
    verifierOrganization: "Korean Air",
    status: "Active",
  },
  {
    code: "KL",
    name: "KLM Royal Dutch Airlines",
    verifierOrganization: "KLM",
    status: "Active",
  },
  {
    code: "AF",
    name: "Air France",
    verifierOrganization: "Air France",
    status: "Active",
  },
  {
    code: "SV",
    name: "Saudia",
    verifierOrganization: "Saudia",
    status: "Active",
  },
];
const verificationColumnOptions: {
  key: VerificationColumnKey;
  label: string;
}[] = [
  { key: "passenger", label: "Passenger" },
  { key: "flight", label: "Flight / Route" },
  { key: "dot", label: "Date of Travel" },
  { key: "ffpNumber", label: "FFP / Membership Number" },
  { key: "tier", label: "Tier / Product" },
  { key: "verifier", label: "Verifier Organization" },
  { key: "evidence", label: "Evidence" },
  { key: "price", label: "Price/Pax" },
  { key: "status", label: "Status" },
];
const dashboardWidgetSeed: DashboardWidget[] = [
  {
    id: "summary",
    titleId: "Ringkasan Eksekutif",
    titleEn: "Executive Summary",
    visible: true,
    roles: ["Super Admin", "Admin", "HO Admin", "Report Viewer"],
  },
  {
    id: "trend",
    titleId: "Tren Jumlah Pengunjung Lounge",
    titleEn: "Lounge Visitor Trend",
    visible: true,
    roles: ["Super Admin", "Admin", "HO Admin", "Report Viewer"],
  },
  {
    id: "composition",
    titleId: "Komposisi Pengunjung",
    titleEn: "Visitor Composition",
    visible: true,
    roles: ["Super Admin", "Admin", "HO Admin", "Report Viewer"],
  },
  {
    id: "utilization",
    titleId: "Lounge Utilization",
    titleEn: "Lounge Utilization",
    visible: true,
    roles: ["Super Admin", "Admin", "HO Admin", "Report Viewer"],
  },
  {
    id: "topBo",
    titleId: "10 BO dengan Pengunjung Terbanyak",
    titleEn: "Top 10 BO by Lounge Visitors",
    visible: true,
    roles: ["Super Admin", "Admin", "HO Admin", "Report Viewer"],
  },
  {
    id: "providerCost",
    titleId: "Analisis Biaya Provider",
    titleEn: "Provider Cost Analysis",
    visible: true,
    roles: ["Super Admin", "Admin", "HO Admin", "Report Viewer"],
  },
  {
    id: "workflow",
    titleId: "Status Verifikasi & Rekonsiliasi",
    titleEn: "Verification & Reconciliation Status",
    visible: true,
    roles: ["Super Admin", "Admin", "HO Admin"],
  },
];
const monitoringSeed: MonitoringRow[] = [
  {
    ...
    bo: "CGK",
    station: "CGK",
    provider: "Garuda Indonesia Executive Lounge T3",
    businessPax: 12500,
    economyPax: 88500,
    businessLounge: 7380,
    platinum: 2140,
  ...
  },
  {
    ...
    bo: "DPS",
    station: "DPS",
    provider: "Garuda Indonesia Executive Lounge DPS",
    businessPax: 4260,
    economyPax: 36400,
    businessLounge: 2510,
    platinum: 810,
  ...
  },
  {
    ...
    bo: "KNO",
    station: "KNO",
    provider: "Plaza Premium Lounge KNO",
    businessPax: 2820,
    economyPax: 25100,
    businessLounge: 1530,
    platinum: 520,
  ...
  },
  {
    ...
    bo: "KUL",
    station: "KUL",
    provider: "Plaza Premium Lounge KUL",
    businessPax: 1480,
    economyPax: 12800,
    businessLounge: 870,
    platinum: 289,
  ...
  },
  {
    ...
    bo: "JED",
    station: "JED",
    provider: "Plaza Premium Lounge JED",
    businessPax: 1320,
    economyPax: 11800,
    businessLounge: 760,
    platinum: 205,
...
function sortData<T>(
  rows: T[],
  sort: SortState,
  getter: (row: T, key: string) => string | number,
) {
  return [...rows].sort((a, b) => {
    const av = getter(a, sort.key),
      bv = getter(b, sort.key);
    const result =
...
export default function Home() {
  ...
  const [season, setSeason] = useState({
    ...
    [seasonNotice, setSeasonNotice] = useState<InlineNotice | null>(null),
    [irregularity, setIrregularity] = useState({
      flight: "",
      date: localDate(),
      type: "Cancelled Date",
      reason: "",
    }),
    [irregularityNotice, setIrregularityNotice] = useState<InlineNotice | null>(
      null,
    );
  ...
  const [roleProfiles, setRoleProfiles] =
    ...
    [reopenStatus, setReopenStatus] = useState<
      "Closed" | "Requested" | "Approved"
    >("Closed");
  const [builderItems, setBuilderItems] = useState<BuilderItem[]>(builderSeed),
    ...
    [builderDraft, setBuilderDraft] = useState<BuilderItem>({
      id: "",
      surface: "Visitor List",
      labelId: "",
      labelEn: "",
    ...
    [dashboardWidgets, setDashboardWidgets] =
      useState<DashboardWidget[]>(dashboardWidgetSeed),
    [dashboardAllowedRoles, setDashboardAllowedRoles] = useState<
      Account["role"][]
  ...
  const [visitorSort, setVisitorSort] = useState<SortState>({
      key: "date",
      direction: "desc",
    }),
    [flightSort, setFlightSort] = useState<SortState>({
      key: "date",
      direction: "asc",
    }),
    [userSort, setUserSort] = useState<SortState>({
      key: "name",
      direction: "asc",
    }),
    [activitySort, setActivitySort] = useState<SortState>({
      key: "time",
      direction: "desc",
    }),
  ...
  const [showUserForm, setShowUserForm] = useState(false),
    ...
    [entitlementNotice, setEntitlementNotice] = useState<InlineNotice | null>(
      null,
    ),
  ...
  const [clockTick, setClockTick] = useState(0),
    ...
    [evidenceType, setEvidenceType] =
      useState<Visitor["evidenceType"]>("Boarding Pass"),
    ...
    [stationNotice, setStationNotice] = useState<InlineNotice | null>(null),
    [airlineDraft, setAirlineDraft] = useState<Airline>({
      code: "",
      name: "",
      verifierOrganization: "",
      status: "Active",
    ...
    [airlineNotice, setAirlineNotice] = useState<InlineNotice | null>(null),
    [userUploadNotice, setUserUploadNotice] = useState<InlineNotice | null>(
      null,
    ),
  ...
  const [language, setLanguage] = useState<"ID" | "EN">("ID"),
    ...
    [manageTableContext, setManageTableContext] = useState<
      "Visitor List" | "Verification"
    >("Visitor List"),
    [verificationColumns, setVerificationColumns] = useState<
      VerificationColumnKey[]
    >(verificationColumnOptions.map((x) => x.key)),
    [showManageReport, setShowManageReport] = useState(false),
    [customColumns, setCustomColumns] = useState<CustomColumn[]>([]),
    [editingCustomColumn, setEditingCustomColumn] = useState<string | null>(
      null,
    ),
    [customColumnDraft, setCustomColumnDraft] = useState<CustomColumn>({
      id: "",
      label: "",
      type: "Calculated",
      formula: "",
      ...
      try {
        ...
        const allowedTabs: MainTab[] = [
          ...
          ...([
            ...
            ? ["master" as MainTab]
            : []),
          ...(dashboardAllowedRoles.includes(account.role)
            ? ["dashboard" as MainTab, "dashboard-detail" as MainTab]
            : []),
        ];
        setTab(
        ...
        if (account.mustChangePassword) {
          setShowProfile(true);
          setProfileNotice(
            "Silakan ganti password sementara sebelum melanjutkan.",
          );
        }
      } finally {
        setAuthReady(true);
  ...
  useEffect(() => {
    ...
    const syncLocation = () => {
      const params = new URLSearchParams(window.location.search);
      params.set("view", tab);
      if (tab === "master") params.set("master", masterTab);
      else params.delete("master");
      if (tab === "reconciliation") params.set("recon", reconTab);
      else params.delete("recon");
      if (tab === "flights") params.set("flight", flightTab);
  ...
  useEffect(() => {
    ...
    const normalizeRows = <T,>(
      rows: unknown[],
      parser: (row: Record<string, unknown>) => unknown,
    ) =>
      rows
        .map((row) => parser(row as Record<string, unknown>))
        .filter(Boolean) as T[];
    ...
    const stops = [
      ...
      subscribeCollection<unknown>(
        "flights",
        (rows) =>
          setFlights(normalizeRows<Flight>(rows, normalizeFlight) as Flight[]),
        undefined,
        subscriptionError,
      ),
      subscribeCollection<unknown>(
      ...
      subscribeCollection<unknown>(
        ...
        (rows) =>
          setStations(
            normalizeRows<Station>(rows, normalizeStation) as Station[],
          ),
        undefined,
        subscriptionError,
      ),
      ...
      subscribeCollection<unknown>(
        ...
        (rows) =>
          setAirlines(
            normalizeRows<Airline>(rows, normalizeAirline) as Airline[],
          ),
        undefined,
        subscriptionError,
      ),
  ...
  useEffect(() => {
    ...
    if (current) return;
    const firstAtAirport = lounges.find(
      (item) => item.airport === airport && item.status !== "Nonaktif",
    );
    if (firstAtAirport) {
      setLoungeId(firstAtAirport.id);
      return;
    }
    const firstAvailable =
      lounges.find((item) => item.status !== "Nonaktif") || lounges[0];
    if (firstAvailable) {
      setAirport(firstAvailable.airport);
      setLoungeId(firstAvailable.id);
    }
  }, [airport, loungeId, lounges]);
  useEffect(() => {
  ...
  async function persistRecords<T extends { id: string }>(
    collectionName: GaesCollection,
    rows: T[],
  ) {
    const results = await Promise.allSettled(
      rows.map((row) => saveRecord(collectionName, row)),
    );
    const saved = rows.filter(
      (_, index) => results[index].status === "fulfilled",
    );
    return { saved, failed: rows.length - saved.length };
  }
  ...
  function moveBuilderItem(id: string, direction: -1 | 1) {
    setBuilderItems((items) => {
      ...
      const sameSurface = items
        .map((item, index) => ({ item, index }))
        .filter(({ item }) => item.surface === items[current].surface);
  ...
  function applyDashboardPeriodToVisitorFilter() {
    if (/^\d{4}-\d{2}$/.test(dashboardPeriod)) {
      ...
      setVisitorDateTo(
        `${dashboardPeriod}-${String(lastDay).padStart(2, "0")}`,
      );
  ...
  function openDashboardVisitors(
    category = "Semua",
    bo = dashboardBo,
  ...
  async function login(e: FormEvent) {
    ...
    if (!auth || !firebaseConfigured) {
      setLoginError("Firebase belum dikonfigurasi pada environment Netlify.");
      return;
    }
    try {
      ...
      const email = identity.includes("@")
        ? identity
        : (await resolveUsername(identity)).email;
      await setPersistence(auth, browserLocalPersistence);
      await signInWithEmailAndPassword(auth, email, loginPassword);
      setLoginError("");
      setLoginPassword("");
      setFlightFilter("Semua");
    } catch {
      setLoginError("Email/username atau password tidak sesuai.");
    }
  }
  ...
  function fieldValue(v: Visitor, field: string): string | number {
    ...
    return (
      (
        {
          "Passenger Name": v.name,
          "Flight Number": v.flight,
          "Date of Travel": v.travelDate || v.date,
          Origin: origin,
          Destination: destination,
          Route: v.route,
          "Cabin Class": v.cabin,
          "Check-in Sequence": v.seq,
          "Ticket Number": v.ticket,
          "Access Category": v.category,
          Reference: v.reference,
          "Companion Count": v.companionCount || 0,
          "Unit Price": v.price,
  ...
  function evaluateFormula(
    ...
    const legacy: Record<string, string> = {
      name: "[Passenger Name]",
      route: "[Route]",
      flightDot: "CONCAT([Flight Number], ' · ', [Date of Travel])",
      accessReference: "CONCAT([Access Category], ' · ', [Reference])",
      payableAmount: "[Unit Price]",
    };
    ...
    const resolveText = (value: string) =>
      value
        .replace(/\[([^\]]+)\]/g, (_, field) => String(fieldValue(v, field)))
        .replace(/^['\"]|['\"]$/g, "");
    const functionMatch = source.match(
      /^(CONCAT|SQRT|ABS|ROUND|MIN|MAX|POWER)\((.*)\)$/i,
    );
    if (functionMatch) {
      ...
      const nums = args.map(
        (arg) => Number(resolveText(arg).replace(/[^0-9.+-]/g, "")) || 0,
      );
    ...
    if (type === "Text" || type === "Date") {
      return source
        .split("+")
        .map((part) => resolveText(part.trim()))
        .join("");
    }
    const numeric = source
      .replace(/\[([^\]]+)\]/g, (_, field) =>
        String(Number(fieldValue(v, field)) || 0),
      )
      .replaceAll("×", "*")
      .replaceAll("÷", "/")
      .replaceAll("^", "**");
  ...
  function read(value: string, source = "input string") {
    if (!accessTravelDate) {
      setNotice({
        kind: "error",
        text: "Pilih Date of Travel pada Langkah 1 sebelum melakukan scan.",
      });
      return;
    }
    ...
    const flightCandidates = flights
      ...
      .map((f) => {
        const dayOffset = Math.round(
          (new Date(`${f.date}T12:00:00Z`).getTime() -
            new Date(`${stationDate}T12:00:00Z`).getTime()) /
            86400000,
        );
        const [fh, fm] = (f.etd || f.std).split(":").map(Number);
        const minutesToDeparture =
          dayOffset * 1440 + fh * 60 + fm - scanMinutes;
      ...
      .filter(
        (x) =>
          x.barcodeMatch ||
          (x.minutesToDeparture >= -120 &&
            x.minutesToDeparture <= accessWindow * 60),
      )
      .sort(
        (a, b) =>
          Number(b.barcodeMatch) - Number(a.barcodeMatch) ||
          Math.abs(a.minutesToDeparture) - Math.abs(b.minutesToDeparture),
      );
  ...
  async function save(e: FormEvent) {
    ...
    const travelDate = pass.travelDate || accessTravelDate;
    const missing = [
      !pass.name.trim() && "Nama",
    ...
    if (missing.length) {
      setNotice({
        kind: "warn",
        text: `${missing.join(", ")} belum diisi atau belum tersedia. Lengkapi data tersebut; data belum disimpan.`,
      });
      return;
    }
    if (!lounge) return;
    ...
    if (
      companionCount > 0 &&
      companionCategory.includes("Membership") &&
      !companionMembership.trim()
    ) {
      setNotice({
        kind: "error",
        text: "Nomor membership pendamping wajib diisi untuk kategori membership.",
      });
      return;
    }
    const key = `${pass.name}|${pass.flight}|${pass.seq}|${travelDate}`
      .toLowerCase()
      .replace(/\s/g, "");
    if (
      visitors.some(
        (v) =>
          `${v.name}|${v.flight}|${v.seq}|${v.travelDate || v.date}`
            .toLowerCase()
            .replace(/\s/g, "") === key,
      )
    ) {
      setActionDialog({
        kind: "warn",
        text: "Penumpang sudah ditambahkan sebagai pengguna layanan lounge.",
      });
      return;
    }
    const n = new Date();
    const scheduled = flights.find(
      (f) => f.date === travelDate && f.flight === pass.flight,
    );
    const departureTime = scheduled?.etd || scheduled?.std;
    const departure = departureTime
      ? new Date(`${travelDate}T${departureTime}:00`)
      : null;
    ...
    const visitor: Visitor = {
      ...
      verifier: ["Business Class", "VIP/CIP/VVIP"].includes(category)
        ...
        : [
          ...
          ? "HO Ancillary"
          : "Partner Airline",
      verifierOrganization: ["Business Class", "VIP/CIP/VVIP"].includes(
        category,
      )
    ...
    try {
      ...
      const message =
        error instanceof Error ? error.message : "Data tidak dapat disimpan.";
      setActionDialog({
        kind: message.includes("sudah ditambahkan") ? "warn" : "error",
        text: message,
      });
      return;
    }
    ...
    setActionDialog({
      kind: "ok",
      text: lateScan
        ? "Penumpang berhasil ditambahkan dan menunggu verifikasi Branch Office karena melewati STD/ETD."
        : "Penumpang berhasil ditambahkan sebagai pengguna layanan lounge.",
    });
  }
  ...
  const shown = useMemo(() => {
    const rows = visitors.filter(
      (v) =>
        ...
        (!visitorFiltersActive ||
          !visitorDateFrom ||
          (v.travelDate || v.date) >= visitorDateFrom) &&
        (!visitorFiltersActive ||
          (!visitorDateFrom && !visitorDateTo) ||
          (v.travelDate || v.date) <= (visitorDateTo || visitorDateFrom)) &&
        (!visitorFiltersActive ||
          !visitorTimeFrom ||
          v.time >= visitorTimeFrom) &&
        ...
        `${v.name} ${v.flight} ${v.category} ${v.lounge}`
          .toLowerCase()
    ...
    return sortData(rows, visitorSort, (v, key) => {
      const values: Record<string, string | number> = {
        ...
        airport: v.airport,
        name: v.name,
        flight: `${v.flight} ${v.seq}`,
        category: `${v.category} ${v.reference}`,
        lounge: v.lounge,
        price: v.price,
        status: `${v.boStatus} ${v.vendorStatus}`,
      };
      return values[key] ?? "";
    });
  }, [
  ...
  const filteredLounges = lounges.filter(
    ...
    filteredAccounts = sortData(
      accounts.filter(
        (a) =>
          ...
          (masterSelect2 === "Semua" ||
            a.station === masterSelect2 ||
            a.status === masterSelect2) &&
    ...
    shownFlights = sortData(
      flights.filter(
        (f) =>
          (isGlobalAdmin
            ? flightFilter === "Semua" || f.origin === flightFilter
            : f.origin === station) &&
          (!flightDateFilter || f.date === flightDateFilter) &&
          (flightStatusFilter === "Semua" || f.status === flightStatusFilter) &&
          `${f.flight} ${f.origin} ${f.destination} ${f.capacity || ""}`
            .toLowerCase()
      ...
      (f, key) =>
        ({
          ...
          capacity: f.capacity || "",
          status: f.status,
          updated: `${f.updatedBy} ${f.updatedAt}`,
        })[key] || "",
    );
  const payableShown = shown.filter((v) => v.boStatus === "Accepted"),
    ...
    reportFilteredShown = shown.filter(
      (v) => reportLoungeFilter === "Semua" || v.lounge === reportLoungeFilter,
    ),
    reportPayableShown = reportFilteredShown.filter(
      (v) => v.boStatus === "Accepted" && v.reconciliationStatus === "Final",
    ),
    reportTotals = reportPayableShown.reduce<Record<string, number>>(
      (total, visitor) => ({
        ...total,
        [visitor.currency]: (total[visitor.currency] || 0) + visitor.price,
      }),
      {},
    );
  const dashboardRows = monitoringRows.filter(
    ...
    dashboardTrend = (() => {
      ...
      const dates = rows
        .map((visitor) => visitor.travelDate || visitor.date)
        .sort();
      if (!dates.length)
        return {
          mode: "Harian",
      ...
      const mode =
        dashboardPeriod === "All Periods" || span > 90
          ? "Bulanan"
          : span > 31
            ? "Mingguan"
            : "Harian";
    ...
    visibleDashboardWidgets = dashboardWidgets.filter(
      (widget) => widget.visible && widget.roles.includes(role),
    );
  const trafficDates = [...new Set(shown.map((v) => v.travelDate || v.date))],
    ...
    traffic = Array.from({ length: 24 }, (_, hour) => {
      const count = shown.filter(
        (v) => Number(v.time.slice(0, 2)) === hour,
      ).length;
  ...
  const verificationQueue = shown.filter((v) => {
      ...
      if (role === "Airline Verifier")
        return (
          ["Partner Airline / SkyTeam", "Kerjasama MPA"].includes(v.category) &&
          (!currentAccount?.organization ||
            v.verifierOrganization === currentAccount.organization ||
            v.reference
              .toLowerCase()
              .includes(currentAccount.organization.toLowerCase()))
        );
      return false;
    }),
    reportReconciliationReady =
      reportFilteredShown.length > 0 &&
      reportFilteredShown.every(
        (v) =>
          v.boStatus === "Accepted" ||
          (v.boStatus === "Rejected" && v.reconciliationStatus === "Final"),
      );
  async function mergeFlights(incoming: Flight[]) {
    ...
    const results = await Promise.allSettled(
      unique.map((item) => saveRecord("flights", item)),
    );
    const saved = unique.filter(
      (_, index) => results[index].status === "fulfilled",
    );
    const failed = results.length - saved.length;
    if (!saved.length)
      throw new Error(
        "Tidak ada data penerbangan yang berhasil disimpan ke Firebase.",
      );
    setFlights((current) => {
      const next = [...current];
      saved.forEach((item) => {
    ...
    setFlightNotice({
      kind: failed ? "warn" : "ok",
      text: `${saved.length} penerbangan berhasil disimpan.${failed ? ` ${failed} data gagal dan tidak dimasukkan.` : ""}`,
    });
    return { saved: saved.length, failed };
  }
  function downloadFlightTemplate() {
    const body =
      "Date,Flight,From,To,STD,ETD,Flight Status,Capacity\n2026-09-20,GA204,CGK,JOG,08:30,08:30,Scheduled,12C 150Y";
    const a = document.createElement("a");
    a.href = URL.createObjectURL(
      new Blob([body], { type: "text/csv;charset=utf-8" }),
    );
    a.download = "template-flight-schedule.csv";
    a.click();
    URL.revokeObjectURL(a.href);
  }
  async function uploadFlights(file: File) {
    try {
      ...
      if (!rows.length)
        throw new Error(
          "File tidak memiliki baris data. Baris kosong diabaikan.",
        );
      const output: Flight[] = [];
      const invalid: number[] = [];
      rows.forEach((row, index) => {
        const blank = Object.values(row).every(
        ...
        const normalized = normalizeFlight({
          ...
          From: row.From ?? row.from ?? row.Origin ?? station,
          To: row.To ?? row.to ?? row.Destination,
          STD: row.STD ?? row.std ?? row.Time,
          ETD: row.ETD ?? row.etd ?? row.STD ?? row.Time,
          "Flight Status": row["Flight Status"] ?? row.Status,
        ...
        output.push(normalized as Flight);
      });
      if (!output.length)
        throw new Error(
          `Tidak ada data flight valid.${invalid.length ? ` Periksa baris ${invalid.slice(0, 10).join(", ")}.` : ""}`,
        );
      const result = await mergeFlights(output);
      if (invalid.length)
        setFlightNotice({
          kind: "warn",
          text: `${result.saved} flight disimpan. ${invalid.length} baris tidak valid diabaikan: ${invalid.slice(0, 10).join(", ")}${invalid.length > 10 ? "…" : ""}.`,
        });
    } catch (e) {
      setFlightNotice({
        kind: "error",
        text: e instanceof Error ? e.message : "File tidak dapat dibaca.",
      });
    }
  }
  async function previewPassengerList(file: File) {
    try {
      ...
      const hasPassenger = keys.some(
        (x) => x.includes("passenger") || x.includes("name"),
      );
      const hasFlight = keys.some((x) => x.includes("flight"));
      const hasDate = keys.some((x) => x.includes("date") || x.includes("dot"));
      if (!rows.length || !hasPassenger || !hasFlight)
        throw new Error(
          "Mapping failed: Passenger Name and Flight Number columns are required.",
        );
      const duplicateCount =
        rows.length - new Set(rows.map((row) => JSON.stringify(row))).size;
      setPassengerImportNotice(
        `Preview only: ${rows.length} rows recognized · ${duplicateCount} duplicate rows · Date of Travel ${hasDate ? "mapped" : "requires mapping"}. Confirm import after Tim IT connects persistent storage.`,
      );
    } catch (error) {
      setPassengerImportNotice(
        error instanceof Error
          ? error.message
          : "Passenger List cannot be read.",
      );
    }
  }
  async function addFlight(e: FormEvent) {
    e.preventDefault();
    const record = normalizeFlight({
      ...newFlight,
      id: editingFlight || undefined,
    ...
    if (!record) {
      setFlightNotice({
        kind: "warn",
        text: "Flight, From, To, tanggal, dan STD harus diisi dengan format yang benar.",
      });
      return;
    }
    try {
      await mergeFlights([record as Flight]);
      setShowAddFlight(false);
      setEditingFlight(null);
      setFlightDateFilter(record.date);
      setNewFlight({
        flight: "",
        origin: station,
        destination: "",
      ...
      setFlightNotice({
        ...
        text:
          error instanceof Error
            ? error.message
            : "Flight tidak dapat disimpan.",
      });
    }
  }
  async function persistFlightChange(id: string, patch: Partial<Flight>) {
    const current = flights.find((item) => item.id === id);
    if (!current) return;
    const updated = {
      ...current,
      ...patch,
    ...
    try {
      await saveRecord("flights", updated);
      setFlights((rows) =>
        rows.map((item) => (item.id === id ? updated : item)),
      );
      setFlightNotice({
        kind: "ok",
        text: `${updated.flight} berhasil diperbarui.`,
      });
    } catch (error) {
      setFlightNotice({
        kind: "error",
        text:
          error instanceof Error
            ? error.message
            : "Perubahan flight tidak dapat disimpan.",
      });
    }
  }
  async function saveIrregularity() {
    const flight = irregularity.flight.toUpperCase().replace(/\s/g, "");
    const date = isoDate(irregularity.date);
    if (!flight || !date || !irregularity.reason.trim()) {
      setIrregularityNotice({
        kind: "warn",
        text: "Flight, tanggal, dan alasan irregularity wajib diisi.",
      });
      return;
    }
    const matches = flights.filter(
      (item) => item.flight === flight && item.date === date,
    );
    if (!matches.length && irregularity.type !== "Extra Flight") {
      setIrregularityNotice({
        kind: "error",
        text: "Flight pada tanggal tersebut tidak ditemukan. Data tidak diubah.",
      });
      return;
    }
    if (irregularity.type === "Extra Flight") {
      setNewFlight((current) => ({ ...current, flight, date }));
      setEditingFlight(null);
      setShowAddFlight(true);
      setIrregularityNotice({
        kind: "warn",
        text: "Lengkapi rute dan waktu pada formulir Tambah Flight untuk membuat extra flight.",
      });
      return;
    }
    const status: FlightStatus =
      irregularity.type === "Cancelled Date"
        ? "Cancelled"
        : irregularity.type === "Suspended Operation"
          ? "Postponed"
          : irregularity.type === "Change STD"
            ? "Rescheduled"
            : "Delayed";
    const updates = matches.map((item) => ({
      ...item,
      status,
      updatedBy: `${role} · ${irregularity.type}`,
      updatedAt: new Date().toISOString(),
      irregularityReason: irregularity.reason.trim(),
    })) as Flight[];
    const result = await persistRecords("flights", updates);
    if (!result.saved.length) {
      setIrregularityNotice({
        kind: "error",
        text: "Irregularity tidak dapat disimpan ke Firebase.",
      });
      return;
    }
    setFlights((rows) =>
      rows.map(
        (item) => result.saved.find((saved) => saved.id === item.id) || item,
      ),
    );
    setIrregularityNotice({
      kind: result.failed ? "warn" : "ok",
      text: `${result.saved.length} flight berhasil diperbarui.${result.failed ? ` ${result.failed} data gagal.` : ""}`,
    });
  }
  async function generateSeasonalSchedule() {
    const start = isoDate(season.start);
    const end = isoDate(season.end);
    const flight = season.flight.toUpperCase().replace(/\s/g, "");
    const origin = season.origin.toUpperCase().trim();
    const destination = season.destination.toUpperCase().trim();
    const days = new Set(season.days.replace(/[^1-7]/g, "").split(""));
    if (
      !start ||
      !end ||
      start > end ||
      ...
      !timeValue(season.std) ||
      !days.size
    ) {
      setSeasonNotice({
        kind: "warn",
        text: "Flight, rute, periode, operating days, dan STD harus diisi dengan format yang benar.",
      });
      return;
    }
    ...
    if ((limit.getTime() - cursor.getTime()) / 86400000 > 550) {
      setSeasonNotice({
        kind: "warn",
        text: "Periode seasonal maksimal 18 bulan untuk satu kali generate.",
      });
      return;
    }
    while (cursor <= limit) {
      const day = cursor.getUTCDay() === 0 ? "7" : String(cursor.getUTCDay());
      if (days.has(day)) {
        const date = cursor.toISOString().slice(0, 10);
        const normalized = normalizeFlight({
          id: `flight-${date}-${flight}-${origin}-${destination}`,
          date,
          flight,
          origin,
          destination,
          ...
          status: "Scheduled",
          updatedBy: `Seasonal ${role}`,
          updatedAt: new Date().toISOString(),
        });
        if (normalized) generated.push(normalized as Flight);
      }
    ...
    if (!generated.length) {
      setSeasonNotice({
        kind: "warn",
        text: "Tidak ada tanggal penerbangan yang cocok dengan operating days pada periode tersebut.",
      });
      return;
    }
    try {
      const result = await mergeFlights(generated);
      setSeasonNotice({
        kind: "ok",
        text: `${result.saved} seasonal flight berhasil dibuat dan disimpan.`,
      });
      setFlightDateFilter(start);
      setFlightTab("Daily Flight");
    } catch (error) {
      setSeasonNotice({
        kind: "error",
        text:
  ...
  async function pdf() {
    const reportRows = payableShown.filter(
      (v) =>
        v.reconciliationStatus === "Final" &&
        (reportLoungeFilter === "Semua" || v.lounge === reportLoungeFilter),
    );
    ...
    const isIndonesia = reportRows.every((v) =>
      stations.some((s) => s.code === v.airport),
    );
    const doc = new jsPDF({
      orientation: reportConfig.columns.length > 8 ? "landscape" : "portrait",
      unit: "mm",
      format: "a4",
    });
    ...
    const reportDate = new Date().toLocaleDateString(
      isIndonesia ? "id-ID" : "en-GB",
      { day: "2-digit", month: "long", year: "numeric" },
    );
    const service =
      [...new Set(reportRows.map((v) => v.lounge))].join(", ") || "—";
    const dates = reportRows.map((v) => v.travelDate || v.date).sort();
    const period =
      dates[0] === dates.at(-1)
        ? dates[0]
        : `${dates[0]} ${isIndonesia ? "s.d." : "to"} ${dates.at(-1)}`;
    const metadataValues: Record<string, string> = {
      ...
      "Airline/Payer": [
        ...new Set(reportRows.map((v) => v.verifier || "—")),
      ].join(", "),
      "Generated Date & Local Time": `${reportDate} · ${localClock(activeTimeZone, language)} ${activeUtcLabel}`,
    };
    doc.setFont("helvetica", "bold");
    doc.setFontSize(14);
    doc.text(reportConfig.title || "Reconciliation Report", pageWidth / 2, 28, {
      align: "center",
    });
    doc.setFont("helvetica", "normal");
    doc.setFontSize(8.5);
    let y = 37;
    reportConfig.metadata.forEach((key) => {
      doc.text(`${key}: ${metadataValues[key] || "—"}`, 14, y, {
    ...
    doc.setFont("helvetica", "bold");
    doc.text(
      `${isIndonesia ? "Total Confirmed Visitor" : "Total Confirmed Visitors"}: ${reportRows.length}`,
      14,
      y + 2,
    );
    if (reportConfig.includeCost) {
      Object.entries(
        reportRows.reduce<Record<string, number>>(
          (a, v) => ({ ...a, [v.currency]: (a[v.currency] || 0) + v.price }),
          {},
        ),
      ).forEach(([currency, total], index) => {
        doc.text(
          `${isIndonesia ? "Estimasi Total Biaya" : "Estimated Total Cost"} ${currency}: ${cash(total, currency)}`,
          14,
          y + 8 + index * 5,
        );
      });
    ...
    const labels: Record<ReportColumnKey, string> = {
      dot: "Date of Travel",
      accessTime: "Access Date & Time",
      station: "Station",
      passenger: "Passenger Name",
      flight: "Flight Number",
      route: "Route",
      category: "Access Category",
      reference: "Reference / Membership",
      guest: "Companion",
      verifier: "Verifier",
      status: "Final Status",
      price: "Price / Cost",
    ...
    const value = (v: Visitor, key: ReportColumnKey) =>
      ({
        ...
        category: v.category,
        reference: v.reference || "—",
        guest: v.companionCount
          ? `${v.companionCount} · ${v.companionCategory || "—"}`
          : "0",
        verifier: v.verifier || "—",
        status: "Confirmed",
    ...
    const selectedColumns = reportConfig.includeCost
      ? [
          ...
          "price" as ReportColumnKey,
        ]
      : reportConfig.columns.filter((key) => key !== "price");
    autoTable(doc, {
      startY: y,
      head: [["No.", ...selectedColumns.map((key) => labels[key])]],
      body: reportRows.map((v, index) => [
        index + 1,
        ...selectedColumns.map((key) => value(v, key)),
      ]),
      ...
      didDrawPage: () => {
        ...
        doc.text(
          `${isIndonesia ? "Halaman" : "Page"} ${doc.getNumberOfPages()}`,
          pageWidth - 14,
    ...
    if (signY > doc.internal.pageSize.getHeight() - 42) {
      doc.addPage();
      signY = 35;
    }
    doc.setFontSize(8.5);
    doc.text(
      isIndonesia
        ? "Penyedia/Pengelola Lounge/Tenant"
        : "Lounge/Tenant Provider",
      pageWidth * 0.28,
      signY,
      { align: "center" },
    );
    ...
    doc.line(pageWidth * 0.16, signY + 28, pageWidth * 0.4, signY + 28);
    doc.line(pageWidth * 0.6, signY + 28, pageWidth * 0.84, signY + 28);
    doc.text(
      vendorSigner || "Vendor Name & Position",
      pageWidth * 0.28,
      signY + 33,
      { align: "center" },
    );
    doc.text(boSigner || "BO Name & Position", pageWidth * 0.72, signY + 33, {
      align: "center",
    });
    if (reportConfig.includeEvidenceAppendix) {
      ...
      if (evidenceRows.length) {
        ...
        doc.setFontSize(13);
        doc.text(
          isIndonesia ? "Appendix Evidence" : "Evidence Appendix",
          pageWidth / 2,
          20,
          { align: "center" },
        );
        autoTable(doc, {
          ...
          body: evidenceRows.map((v, index) => [
            index + 1,
            v.name,
            `${v.flight} / ${v.travelDate || v.date}`,
            v.evidenceType || "Supporting Document",
            v.evidenceName || "—",
            `BO ${evidenceBoRetention} days · Super Admin ${evidenceAdminRetention} days`,
          ]),
          styles: { fontSize: 8, cellPadding: 2 },
          headStyles: { fillColor: [7, 95, 123] },
        });
      }
    }
    const fileName = (
      reportConfig.fileName ||
      "Reconciliation_Report_{Station}_{StartDate}_{EndDate}"
    )
      .replace(
        "{Station}",
        effectiveVisitorFilter === "Semua" ? "ALL" : effectiveVisitorFilter,
      )
  ...
  async function uploadLounges(file: File) {
    try {
      ...
      const incoming = rows
        .map((row, index) => {
          if (Object.values(row).every((value) => !normalizedText(value)))
            return null;
          const normalized = normalizeLounge(row);
          if (!normalized || !normalized.end) invalid.push(index + 2);
          return normalized?.end ? (normalized as Lounge) : null;
        })
        .filter(Boolean) as Lounge[];
      if (!incoming.length)
        throw new Error(
          `Tidak ada data lounge/tenant yang valid.${invalid.length ? ` Periksa baris ${invalid.join(", ")}.` : ""}`,
        );
      const result = await persistRecords("lounges", incoming);
      setLounges((current) => {
        const next = [...current];
        result.saved.forEach((item) => {
      ...
      setLoungeNotice({
        ...
        text: `${result.saved.length} lounge/tenant berhasil disimpan.${invalid.length + result.failed ? ` ${invalid.length + result.failed} baris gagal/diabaikan.` : ""}`,
      });
    } catch (e) {
      setLoungeNotice({
        kind: "error",
  ...
  async function saveUser(e: FormEvent) {
    ...
    if (!/^[a-z0-9._-]{3,40}$/i.test(userDraft.username.trim())) {
      setUserUploadNotice({
        kind: "warn",
        text: "Username harus 3–40 karakter dan hanya boleh berisi huruf, angka, titik, garis bawah, atau tanda minus.",
      });
      return;
    }
    if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(userDraft.email.trim())) {
      setUserUploadNotice({ kind: "warn", text: "Format email tidak valid." });
      return;
    }
    if (!editingUser && userDraft.password.length < 8) {
      setUserUploadNotice({
        kind: "warn",
        text: "Password sementara minimal 8 karakter.",
      });
      return;
    }
    if (
      userDraft.station !== "ALL" &&
      !stations.some((s) => s.code === userDraft.station)
    ) {
      setUserUploadNotice({
        kind: "warn",
        text: "Station yang dipilih tidak valid.",
      });
      return;
    }
    if (role !== "Super Admin" && userDraft.role === "Super Admin") {
      setUserUploadNotice({
        kind: "warn",
        text: "Hanya Super Admin yang dapat membuat akun Super Admin.",
      });
      return;
    }
    const roleScope =
    ...
    const normalizedDraft = {
      ...userDraft,
      scope: `${roleScope} · ${userDraft.station === "ALL" ? "Seluruh Station" : `Station ${userDraft.station}`}`,
    };
    setSavingUser(true);
    try {
      if (editingUser) {
        await updateManagedUser(firebaseUser, {
          ...normalizedDraft,
          uid: editingUser,
        });
        ...
        setUserUploadNotice({
          kind: "ok",
          text: "Akun berhasil dibuat. Sampaikan password sementara dan minta pengguna menggantinya saat login pertama.",
        });
      }
      ...
      setUserUploadNotice({
        kind: "error",
        text:
          error instanceof Error ? error.message : "Akun tidak dapat dibuat.",
      });
    } finally {
      setSavingUser(false);
    }
  ...
  async function uploadUsers(file: File) {
    ...
    try {
      ...
      setUserUploadNotice({
        kind: "error",
        text: "File akun tidak dapat dibaca. Gunakan template CSV/XLSX yang disediakan.",
      });
      return;
    }
    ...
    rows.forEach((r, index) => {
      if (Object.values(r).every((value) => !normalizedText(value))) return;
      const name = String(r["Full Name"] || "").trim(),
        username = String(r.Username || "").trim(),
        email = String(r.Email || "").trim(),
        password = String(r["Temporary Password"] || ""),
        accountRole = String(r.Role || "") as Account["role"],
      ...
      if (
        !name ||
        !/^[a-z0-9._-]{3,40}$/i.test(username) ||
        !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email) ||
        password.length < 8 ||
        !validRoles.includes(accountRole) ||
        ...
        errors.push(
          `Baris ${index + 2}: nama, username, role, station, atau duplikasi tidak valid.`,
        );
        return;
      }
      incoming.push({
    ...
    if (!incoming.length || !firebaseUser) {
      setUserUploadNotice({
        kind: "error",
        text: `0 akun dibuat.${errors.length ? ` ${errors.length} baris gagal divalidasi.` : " Tidak ada data akun yang valid."}`,
      });
      return;
    }
    ...
    try {
      ...
      errors.push(
        ...result.errors.map((item) => `Baris ${item.row}: ${item.error}`),
      );
      const kind: InlineNotice["kind"] =
        result.created === 0 ? "error" : errors.length ? "warn" : "ok";
      setUserUploadNotice({
        kind,
        text: `${result.created} akun berhasil dibuat.${errors.length ? ` ${errors.length} baris gagal diproses.` : ""}`,
      });
    } catch (error) {
      setUserUploadNotice({
        kind: "error",
        text:
          error instanceof Error
            ? error.message
            : "Import akun tidak dapat diproses.",
      });
    }
  }
  function downloadStationTemplate() {
    const body =
      "IATA Code,Station Name,Time Zone,UTC Label,Status\nCGK,Soekarno-Hatta,Asia/Jakarta,UTC+7,Aktif";
    const a = document.createElement("a");
    a.href = URL.createObjectURL(new Blob([body], { type: "text/csv" }));
    a.download = "template-master-station.csv";
    a.click();
    URL.revokeObjectURL(a.href);
  }
    ...
    try {
      ...
      const incoming = rows
        .map((row, index) => {
          if (Object.values(row).every((value) => !normalizedText(value)))
            return null;
          const item = normalizeStation({
            id: row["IATA Code"],
            code: row["IATA Code"],
            name: row["Station Name"],
            timeZone: row["Time Zone"],
            utcLabel: row["UTC Label"],
            status: row.Status,
          });
          if (!item) invalid.push(index + 2);
      ...
      setStationNotice({
        ...
        text:
          error instanceof Error
            ? error.message
            : "File station tidak dapat dibaca.",
      });
    }
  }
  async function saveStation(e: FormEvent) {
    ...
    if (
      ...
      setStationNotice({
        kind: "warn",
        text: "Kode IATA tiga huruf dan nama station wajib valid.",
      });
      return;
    }
    ...
    try {
      ...
      setStations((xs) =>
        editingStation
          ? xs.map((item) => (item.code === editingStation ? record : item))
          : [...xs, record],
      );
      ...
      setStationNotice({
        kind: "ok",
        text: `Station ${code} berhasil ${editingStation ? "diperbarui" : "ditambahkan"}.`,
      });
      setActionDialog({
        kind: "ok",
        text: `Station ${code} berhasil ${editingStation ? "diperbarui" : "ditambahkan"}.`,
      ...
      setStationNotice({
        ...
        text:
          error instanceof Error
            ? error.message
            : "Station tidak dapat disimpan.",
      });
    }
  }
  function downloadAirlineTemplate() {
    const body =
      "2-Letter Code,Airline,Verifier Organization,Status\nGA,Garuda Indonesia,Garuda Indonesia,Active";
    const a = document.createElement("a");
    a.href = URL.createObjectURL(new Blob([body], { type: "text/csv" }));
    a.download = "template-master-airline.csv";
    a.click();
    URL.revokeObjectURL(a.href);
  }
    ...
    try {
      ...
      const incoming = rows
        .map((row, index) => {
          if (Object.values(row).every((value) => !normalizedText(value)))
            return null;
          const item = normalizeAirline({
            id: row["2-Letter Code"],
            code: row["2-Letter Code"],
            name: row.Airline,
            verifierOrganization: row["Verifier Organization"],
            status: row.Status,
          });
          if (!item) invalid.push(index + 2);
          return item ? { ...item, id: item.code } : null;
        })
        .filter(Boolean) as Array<Airline & { id: string }>;
      if (!incoming.length)
        throw new Error(
          `Tidak ada airline valid.${invalid.length ? ` Periksa baris ${invalid.join(", ")}.` : ""}`,
        );
      const result = await persistRecords("airlines", incoming);
      setAirlineNotice({
        kind: invalid.length + result.failed ? "warn" : "ok",
        text: `${result.saved.length} airline berhasil disimpan.${invalid.length + result.failed ? ` ${invalid.length + result.failed} baris gagal/diabaikan.` : ""}`,
      });
    } catch (error) {
      setAirlineNotice({
        kind: "error",
        text:
          error instanceof Error
            ? error.message
            : "File airline tidak dapat dibaca.",
      });
    }
  }
  async function saveAirline(e: FormEvent) {
    ...
    if (
      !/^[A-Z0-9]{2}$/.test(code) ||
      !airlineDraft.name ||
      (!editingAirline && airlines.some((item) => item.code === code))
    ) {
      setAirlineNotice({
        kind: "warn",
        text: "Kode airline dua karakter dan nama airline wajib valid.",
      });
      return;
    }
    ...
    try {
      ...
      setAirlines((rows) =>
        editingAirline
          ? rows.map((item) => (item.code === editingAirline ? record : item))
          : [...rows, record],
      );
      ...
      setAirlineNotice({
        kind: "ok",
        text: `Airline ${code} berhasil ${editingAirline ? "diperbarui" : "ditambahkan"}.`,
      });
      setActionDialog({
        kind: "ok",
        text: `Airline ${code} berhasil ${editingAirline ? "diperbarui" : "ditambahkan"}.`,
      ...
      setAirlineNotice({
        ...
        text:
          error instanceof Error
            ? error.message
            : "Airline tidak dapat disimpan.",
      });
    }
  }
  function downloadEntitlementTemplate() {
    const body =
      "Type,Name,Reference,Status,Verifier Organization,Eligible Tier,Effective Start,Effective End,Station Scope,Payer,Price Rule,Companion Rule,API Reference Fields\nMembership,GarudaMiles Platinum,Membership policy,Aktif,HO Ancillary,Platinum,2026-01-01,2026-12-31,ALL,Garuda Indonesia,Lounge unit price,1 companion,memberNumber|tier|status";
    const a = document.createElement("a");
    a.href = URL.createObjectURL(new Blob([body], { type: "text/csv" }));
    a.download = "template-access-entitlement.csv";
    a.click();
    URL.revokeObjectURL(a.href);
  }
      ...
      const incoming = rows
        .map((row, index) => {
          ...
          const item = normalizeEntitlement({
            id: `entitlement-${normalizedText(row.Type, "partnership").toLowerCase()}-${name.toLowerCase().replace(/[^a-z0-9]+/g, "-")}`,
            type: row.Type,
            name,
            reference,
            status: row.Status,
            allowedRoles: ["Super Admin", "Admin"],
            verifierOrganization: row["Verifier Organization"],
            eligibleTiers: row["Eligible Tier"],
            effectiveStart: row["Effective Start"],
            effectiveEnd: row["Effective End"],
            stationScope: row["Station Scope"],
            payer: row.Payer,
            priceRule: row["Price Rule"],
            companionRule: row["Companion Rule"],
            apiReferenceFields: normalizedText(
              row["API Reference Fields"],
            ).replaceAll("|", ","),
            version: 1,
          });
          if (!item || !reference) invalid.push(index + 2);
          return item && reference ? (item as Partnership) : null;
        })
        .filter(Boolean) as Partnership[];
      if (!incoming.length)
        throw new Error(
          `Tidak ada entitlement valid.${invalid.length ? ` Periksa baris ${invalid.join(", ")}.` : ""}`,
        );
      const result = await persistRecords("entitlements", incoming);
      setEntitlementNotice({
        kind: invalid.length + result.failed ? "warn" : "ok",
        text: `${result.saved.length} access entitlement berhasil disimpan.${invalid.length + result.failed ? ` ${invalid.length + result.failed} baris gagal/diabaikan.` : ""}`,
      });
    } catch (error) {
      setEntitlementNotice({
        kind: "error",
        text:
          error instanceof Error
            ? error.message
            : "File entitlement tidak dapat dibaca.",
      });
    }
  }
  async function savePartnership(e: FormEvent) {
    e.preventDefault();
    if (
      !partnershipDraft.name ||
      !partnershipDraft.reference ||
      !partnershipDraft.allowedRoles.length
    ) {
      setEntitlementNotice({
        kind: "warn",
        text: "Nama, reference, dan role wajib diisi.",
      });
      return;
    }
    const record = {
      ...partnershipDraft,
      id: editingPartnership || crypto.randomUUID(),
    };
    try {
      await saveRecord("entitlements", record);
      if (editingPartnership)
        setPartnerships((xs) =>
          xs.map((x) => (x.id === editingPartnership ? record : x)),
        );
      ...
      setEntitlementNotice({
        kind: "ok",
        text: `Produk/Agreement berhasil ${editingPartnership ? "diperbarui" : "ditambahkan"}.`,
      });
      setActionDialog({
        kind: "ok",
        text: `Produk/Agreement berhasil ${editingPartnership ? "diperbarui" : "ditambahkan"}.`,
      ...
      setEntitlementNotice({
        ...
        text:
          error instanceof Error
            ? error.message
            : "Produk/Agreement tidak dapat disimpan.",
      });
    }
  }
  if (!authReady) {
    return (
      <main className="loginPage">
        <section className="sessionLoader" aria-live="polite">
    ...
    <main>
      ...
      <div className={`shell ${sidebarCollapsed ? "sidebarCollapsed" : ""}`}>
          ...
          <nav>
            {canSeeDashboard && (
              <Link
                href="/?view=dashboard"
                className={
                  tab === "dashboard" || tab === "dashboard-detail"
                    ? "active"
                    : ""
                }
                onClick={(e) => {
            ...
            >
              <i>LA</i>
              <span>Lounge/Tenant Access</span>
            </Link>
            <Link
              href="/?view=reconciliation"
            ...
            >
              <i>VR</i>
              <span>Visitor &amp; Reconciliation</span>
            </Link>
            {role !== "Lounge Officer" && (
              <Link
                href="/?view=flights"
        ...
        <section className="content">
          {tab === "dashboard" && canSeeDashboard && (
            <>
              <Title
                eye="MANAGEMENT & MONITORING"
                title="Dashboard"
                sub="Ringkasan penggunaan lounge, komposisi pengunjung, utilisasi, biaya, dan kinerja BO sesuai kewenangan akun."
              />
              <article className="card dashboardFilterCard">
                <div className="dashboardFilters">
                  ...
                  <FilterField label="Area">
                    <SearchableSelect
                      value={dashboardArea}
                      onChange={setDashboardArea}
                      options={[
                        "All Areas",
                        ...new Set(monitoringRows.map((row) => row.area)),
                      ]}
                      placeholder="Select area"
                    />
                  </FilterField>
                  <FilterField label="Branch Office">
                    <SearchableSelect
                      value={dashboardBo}
                  ...
                  <FilterField label="Lounge / Provider">
                    <SearchableSelect
              ...
              {visibleDashboardWidgets.some(
                ...
                <div className="dashboardKpis">
                  ...
                  <button type="button" onClick={() => openDashboardReport()}>
                    ...
                    <b>{cash(dashboardTotals.cost, "IDR")}</b>
                    <small>
                      Filtered scope <i>View report →</i>
                    </small>
                  </button>
                </div>
              )}
              ...
              {visibleDashboardWidgets.some(
                (widget) => widget.id === "trend",
              ) && (
                <article className="card dashboardTrend">
                  <div>
                    <h2>
                      {language === "EN"
                        ? "Lounge Visitor Trend"
                        : "Tren Jumlah Pengunjung Lounge"}
                    </h2>
                    <span>
                      Agregasi {dashboardTrend.mode.toLowerCase()} menyesuaikan
                      periode terpilih.
                    </span>
                  </div>
                  <div className="trendPlot">
                    {dashboardTrend.points.length ? (
                      dashboardTrend.points.map((point) => (
                        <button
                          key={point.label}
                          type="button"
                          title={`${point.label}: ${point.value}`}
                          onClick={() => openDashboardVisitors()}
                        >
                          <i
                            style={{
                              height: `${Math.max(8, (point.value / Math.max(...dashboardTrend.points.map((item) => item.value))) * 100)}%`,
                            }}
                          />
                      ...
                      <p>Belum ada data visitor pada filter ini.</p>
                    )}
                  </div>
                </article>
              )}
              ...
              <div className="dashboardGrid">
                {visibleDashboardWidgets.some(
                  (widget) => widget.id === "composition",
                ) && (
                  <article className="card dashboardWidget">
                    <h2>
                      {language === "EN"
                        ? dashboardWidgets.find((x) => x.id === "composition")
                            ?.titleEn
                        : dashboardWidgets.find((x) => x.id === "composition")
                            ?.titleId}
                    </h2>
                ...
                {visibleDashboardWidgets.some(
                  ...
                  <article className="card dashboardWidget">
                    <h2>
                      {language === "EN"
                        ? dashboardWidgets.find((x) => x.id === "utilization")
                            ?.titleEn
                        : dashboardWidgets.find((x) => x.id === "utilization")
                            ?.titleId}
                    </h2>
                ...
                {visibleDashboardWidgets.some(
                  (widget) => widget.id === "topBo",
                ) && (
                  <article className="card dashboardWidget dashboardTableWidget">
                    <h2>
                      {language === "EN"
                        ? dashboardWidgets.find((x) => x.id === "topBo")
                            ?.titleEn
                        : dashboardWidgets.find((x) => x.id === "topBo")
                            ?.titleId}
                    </h2>
                      ...
                      <table className="dashboardTable">
                        <thead>
                          <tr>
                            ...
                            <th>Contribution</th>
                            <th>Average / Day</th>
                            <th>Average Cost / Visitor</th>
                            <th>Total Cost</th>
                          </tr>
                        </thead>
                        <tbody>
                          {dashboardTopBo.map((item, index) => (
                            <tr key={item.name}>
                              <td>
                                <b>{index + 1}</b>
                              </td>
                              <td>
                                <button
                                  className="tableLink"
                                  onClick={() =>
                                    openDashboardVisitors("Semua", item.name)
                                  }
                                >
                                  {item.name} →
                                </button>
                              ...
                              <td>{item.area}</td>
                              <td>{item.visitors.toLocaleString("id-ID")}</td>
                              <td>
                                {dashboardVisitorCount
                                  ? (
                                      (item.visitors / dashboardVisitorCount) *
                                      100
                                    ).toFixed(1)
                                  : "0.0"}
                                %
                              ...
                              <td>
                                {(item.visitors / dashboardDays).toLocaleString(
                                  "id-ID",
                              ...
                              <td>
                                {cash(
                                  item.visitors ? item.cost / item.visitors : 0,
                                  "IDR",
                                )}
                              </td>
                              <td>{cash(item.cost, "IDR")}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
                ...
                {visibleDashboardWidgets.some(
                  (widget) => widget.id === "providerCost",
                ) && (
                  <article className="card dashboardWidget dashboardTableWidget">
                    <h2>
                      {language === "EN"
                        ? dashboardWidgets.find((x) => x.id === "providerCost")
                            ?.titleEn
                        : dashboardWidgets.find((x) => x.id === "providerCost")
                            ?.titleId}
                    </h2>
                    <div className="dashboardTableWrap">
                      <table className="dashboardTable">
                        ...
                        <tbody>
                          {dashboardProviders.map((item) => (
                            <tr key={item.name}>
                              <td>
                                <button
                                  className="tableLink"
                                  onClick={() => openDashboardReport(item.name)}
                                >
                                  {item.name} →
                                </button>
                              </td>
                              ...
                              <td>
                                {dashboardTotals.cost
                                  ? (
                                      (item.cost / dashboardTotals.cost) *
                                      100
                                    ).toFixed(1)
                                  : "0.0"}
                                %
                ...
                {visibleDashboardWidgets.some(
                  (widget) => widget.id === "workflow",
                ) && (
                  <article className="card dashboardWidget dashboardWorkflow">
                    <h2>
                      {language === "EN"
                        ? dashboardWidgets.find((x) => x.id === "workflow")
                            ?.titleEn
                        : dashboardWidgets.find((x) => x.id === "workflow")
                            ?.titleId}
                    </h2>
                    <div>
                      <button
                        onClick={() => {
                          setTab("reconciliation");
                          setReconTab("Pending Verification");
                        }}
                      >
                        <b>
                          {
                            visitors.filter((v) => v.boStatus === "Pending")
                              .length
                          }
                        </b>{" "}
                      ...
                      >
                        <b>
                          {
                            visitors.filter((v) => v.boStatus === "Rejected")
                              .length
                          }
                        </b>{" "}
                        Dispute
                      ...
                      >
                        <b>
                          {
                            visitors.filter(
                              (v) => v.reconciliationStatus === "Final",
                            ).length
                          }
                        </b>{" "}
          ...
          {tab === "dashboard-detail" && canSeeDashboard && (
            <>
              <div className="dashboardDetailHead">
                <Title
              ...
              <article className="card tableCard dashboardDetailCard">
                <div className="detailSummary">
                  <span>
                    Period <b>{dashboardPeriod}</b>
                  </span>
                  <span>
                    Area <b>{dashboardArea}</b>
                  </span>
                  <span>
                    Branch Office <b>{dashboardBo}</b>
                  </span>
                  <span>
                    Provider <b>{dashboardProvider}</b>
                  </span>
                  <span>
                    Total{" "}
                    <b>
                ...
                <form className="card" onSubmit={save}>
                  ...
                  <div className="form">
                    ...
                    <label className="dotPreviewField">
                      ...
                      />
                      <small className="fieldAlignmentHint">
                        {pass.travelDate ? (
                          `Sumber: ${pass.dateSource || "Manual"}`
                        ) : (
                          <>&nbsp;</>
                        )}
                      </small>
                    ...
                    {[
                      ...
                      <div className="full companionPanel">
                        <div>
                          <b>Companion</b>
                          <span>
                            Isi manual bila entitlement memperbolehkan
                            pendamping.
                          </span>
                        </div>
                        <label>
                          ...
                          <>
                            <label>
                              ...
                              <select
                                ...
                                onChange={(e) => {
                                  setCompanionCategory(e.target.value);
                                  if (!e.target.value.includes("Membership"))
                                    setCompanionMembership("");
                                }}
                              >
                                <option>Platinum</option>
                                <option>DPR</option>
                                <option>Membership Lainnya</option>
                            ...
                            {companionCategory.includes("Membership") && (
                              <label>
                                Nomor Membership
                                <input
                                  value={companionMembership}
                                  onChange={(e) =>
                                    setCompanionMembership(e.target.value)
                                  }
                                  placeholder="Nomor membership pendamping"
                                />
                              </label>
                            )}
                          </>
                  ...
                  <div className="dupe">
                    ...
                    <span>
                      Passenger + Flight + Check-in Sequence + Date of Travel
                    </span>
                  </div>
                ...
                <>
                  <div className="title actionTitle">
                    ...
                    <div>
                      {role === "Super Admin" && (
                        <button
                          onClick={() => {
                            setManageTableContext("Visitor List");
                      ...
                      <button
                        ...
                        onClick={() =>
                          askDelete(
                            "Kosongkan seluruh visitor?",
                            "Semua data visitor pada perangkat ini akan dihapus. Activity Log produksi tetap dipertahankan.",
                            () => setVisitors([]),
                          )
                        }
                      >
                  ...
                  <article className="card trafficCard">
                    <div className="trafficHead">
                      <div>
                        <span>AVERAGE PASSENGER TRAFFIC PER HOUR</span>
                        <h2>Peak Hour Visitor</h2>
                      </div>
                      <button
                        className={
                          visitorFiltersActive ? "primary" : "secondary"
                        }
                        onClick={() => setVisitorFiltersActive((x) => !x)}
                      >
                        {visitorFiltersActive
                          ? "Filter Aktif"
                          : "Aktifkan Filter"}
                    ...
                    {visitorFiltersActive && (
                      <div className="advancedFilters">
                        ...
                        <label>
                          ...
                          <input
                            type="time"
                            value={visitorTimeFrom}
                            onChange={(e) => setVisitorTimeFrom(e.target.value)}
                          />
                        </label>
                        <label>
                          Jam akhir
                          <input
                            type="time"
                            value={visitorTimeTo}
                            onChange={(e) => setVisitorTimeTo(e.target.value)}
                          />
                        </label>
                      </div>
                    )}
                      ...
                      <span>
                        ...
                        <b>
                          {(
                            shown.length /
                            24 /
                            Math.max(trafficDates.length, 1)
                          ).toFixed(1)}
                        </b>
                      </span>
                      <span>
                        Peak hour <b>{String(peak.hour).padStart(2, "0")}:00</b>
                      </span>
                      <span>
                        Peak traffic <b>{peak.average.toFixed(1)}</b>
                      </span>
                      <span>
                        Accepted{" "}
                        <b>
                          {
                            shown.filter((v) => v.boStatus === "Accepted")
                              .length
                          }
                        </b>
                      </span>
                    ...
                    <div
                      ...
                      aria-label="Grafik rata-rata visitor per jam"
                    >
                      {traffic.map((item) => (
                        <div
                          className="trafficBarCell"
                          key={item.hour}
                          title={`${String(item.hour).padStart(2, "0")}:00 · rata-rata ${item.average.toFixed(1)} · total ${item.total}`}
                        >
                          <div
                            className="trafficBar"
                            style={{
                              height: `${Math.max(item.average ? 8 : 1, (item.average / trafficMax) * 100)}%`,
                            }}
                          />
                  ...
                  <div className="stats">
                    ...
                    {Object.entries(totals).map(([c, n]) => (
                      <div key={c}>
                        ...
                        <b>{cash(n, c)}</b>
                        <small>
                          Total hanya menghitung visitor Accepted sesuai filter
                          aktif.
                        </small>
                      </div>
                    ))}
                  ...
                  <article className="card tableCard">
                    <div className="filters threeFilters">
                      ...
                      <FilterField label="Passenger Category">
                        <SearchableSelect
                          value={visitorCategoryFilter}
                          onChange={setVisitorCategoryFilter}
                          options={[
                            "Semua",
                            ...new Set(visitors.map((v) => v.category)),
                          ]}
                          placeholder="Passenger Category"
                        />
                      </FilterField>
                      <FilterField label="Visitor Status">
                        <SearchableSelect
                          value={visitorStatusFilter}
                          onChange={setVisitorStatusFilter}
                          options={[
                            "All Status",
                            "Accepted",
                            "Declined",
                      ...
                      <FilterField label="Search Visitor">
                        <input
                          value={query}
                          onChange={(e) => setQuery(e.target.value)}
                          placeholder="Nama / flight / lounge"
                        />
                      </FilterField>
                        ...
                        <thead>
                          <tr>
                            <SortTh
                              ...
                              current={visitorSort}
                              onSort={(key) =>
                                setVisitorSort((s) => nextSort(s, key))
                              }
                            />
                            <SortTh
                              label="Scan / Date of Travel"
                              sortKey="date"
                              current={visitorSort}
                              onSort={(key) =>
                                setVisitorSort((s) => nextSort(s, key))
                            ...
                            shown.map((v, i) => (
                              <tr key={v.id}>
                                ...
                                <td>
                                  ...
                                  <small>
                                    {v.verifier || "Verifier belum ditentukan"}
                                  </small>
                                </td>
                                {customColumns
                                  .filter((c) => c.visible)
                          ...
                          <tr>
                            ...
                            >
                              <b>
                                ...
                                · {shown.length} rows · {payableShown.length}{" "}
                                confirmed/payable
                              </b>
                            </td>
                            <td colSpan={2}>
              ...
              {reconTab === "Verifier Review" && (
                <VerificationPanel
                  ...
                  onManageTable={
                    role === "Super Admin"
                      ? () => {
                          setManageTableContext("Verification");
                          setShowManageTable(true);
                        }
                      : undefined
                  }
                ...
                <article className="card tableCard">
                  <div className="miniHead">
                    <div>
                      ...
                      <span>
                        Data yang ditolak verifier dikembalikan kepada Lounge
                        Officer. Tombol koreksi hanya muncul untuk data yang
                        memerlukan respons Lounge sesuai scope akun.
                      </span>
                    </div>
                    <mark className="yellow">
                      {shown.filter((x) => x.boStatus === "Rejected").length}{" "}
                      DISPUTE
                    </mark>
                  </div>
                  <div className="tableWrap">
                    <table>
                      <thead>
                        <tr>
                          <SortTh
                            ...
                            current={disputeSort}
                            onSort={(key) =>
                              setDisputeSort((s) => nextSort(s, key))
                            }
                          />
                          <SortTh
                            label="Flight"
                      ...
                      <tbody>
                        {shown.filter((x) => x.boStatus === "Rejected")
                          .length ? (
                          shown
                            .filter((x) => x.boStatus === "Rejected")
                            .sort((a, b) => {
                              const av =
                                disputeSort.key === "name"
                                  ? a.name
                                  : disputeSort.key === "flight"
                                    ? a.flight
                                    : disputeSort.key === "reason"
                                      ? a.boReason
                                      : a.boStatus;
                              const bv =
                                disputeSort.key === "name"
                            ...
                            .map((v) => (
                              <tr key={v.id}>
                                ...
                                <td>
                                  <mark className="red">
                                    Menunggu Respons Lounge
                                  </mark>
                                  {v.evidenceName && (
                                    <small>Evidence: {v.evidenceName}</small>
                                  )}
                                </td>
                                <td>
                                  {canVendorConfirm ? (
                                    ...
                                    <span className="statusText">
                                      Menunggu koreksi petugas lounge
                                    </span>
                                  )}
                                </td>
                              </tr>
              ...
              {reconTab === "Reports & Sign-off" && (
                <article className="card signoff">
                  ...
                  <div className="filters threeFilters reportFilters">
                    ...
                    <FilterField label="Start Date">
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          setVisitorFiltersActive(
                            Boolean(e.target.value || visitorDateTo),
                          );
                        }}
                      />
                    </FilterField>
                    <FilterField label="End Date">
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          setVisitorFiltersActive(
                            Boolean(e.target.value || visitorDateFrom),
                          );
                        }}
                      />
                    </FilterField>
                    ...
                    <FilterField label="Lounge / Provider">
                      <SearchableSelect
                        value={reportLoungeFilter}
                        onChange={setReportLoungeFilter}
                        options={[
                          "Semua",
                          ...new Set(
                            visitors
                    ...
                    <FilterField label="Search Visitor">
                      <input
                        value={query}
                        onChange={(e) => setQuery(e.target.value)}
                        placeholder="Nama penumpang / flight / lounge"
                      />
                    </FilterField>
                    <span>
                      {visitorDateFrom || "All Date"}
                      {visitorDateTo ? ` – ${visitorDateTo}` : ""} ·{" "}
                      {reportFilteredShown.length} filtered ·{" "}
                      {reportPayableShown.length} confirmed
                    </span>
                  </div>
                  <div
                    className={`reconciliationGate ${reportReconciliationReady ? "ready" : "blocked"}`}
                  >
                    <b>
                      {reportReconciliationReady
                        ? "Rekonsiliasi periode selesai"
                        : "Sign-off belum tersedia"}
                    </b>
                    <span>
                      {reportReconciliationReady
                        ? "Seluruh visitor pada hasil filter telah memiliki keputusan final."
                        : `${reportFilteredShown.filter((v) => v.boStatus === "Pending" || (v.boStatus === "Rejected" && v.reconciliationStatus !== "Final")).length} data pada hasil filter masih pending/dispute.`}
                    </span>
                  </div>
                  <div className="reportButtons singleReportTools">
                    {canManageMaster && (
                      <button onClick={() => setShowManageReport(true)}>
                        Manage Report
                      </button>
                    )}
                    <label className="costToggle">
                      <input
                        type="checkbox"
                        checked={reportConfig.includeCost}
                        onChange={(e) =>
                          setReportConfig({
                            ...reportConfig,
                    ...
                    <label className="costToggle">
                      <input
                        type="checkbox"
                        checked={reportConfig.includeEvidenceAppendix}
                        onChange={(e) =>
                          setReportConfig({
                            ...reportConfig,
                            includeEvidenceAppendix: e.target.checked,
                          })
                        }
                      />{" "}
                      Evidence Appendix
                  ...
                  {boSigned && vendorSigned && (
                    <div className="reopenWorkflow">
                      <b>Reopen Reconciliation</b>
                      <span>
                        BO submits a request; Admin approves or rejects with an
                        audit reason and report revision.
                      </span>
                      {role === "BO Admin" && reopenStatus === "Closed" && (
                        <button onClick={() => setReopenStatus("Requested")}>
                          Request Reopen
                        </button>
                      )}
                      {role === "Admin" && reopenStatus === "Requested" && (
                        <button
                          className="primary"
                          onClick={() => {
                            setReopenStatus("Approved");
                            setBoSigned(false);
                            setVendorSigned(false);
                            setVisitors((xs) =>
                              xs.map((v) => ({
                                ...v,
                                reportRevision: (v.reportRevision || 1) + 1,
                              })),
                            );
                          }}
                        >
                  ...
                  <div className="stats">
                    ...
                    {Object.entries(reportTotals).map(([c, n]) => (
                      <div key={c}>
                        ...
                        <b>{cash(n, c)}</b>
                        <small>
                          Confirmed/final visitor sesuai periode, station,
                          category, lounge, dan pencarian
                        </small>
                      </div>
                    ))}
                  </div>
                  <div className="signGrid roleSignGrid">
                    <div className="signParty">
                      ...
                      <mark className={boSigned ? "green" : "yellow"}>
                        {boSigned ? "SIGNED" : "MENUNGGU BO"}
                      </mark>
                      {canBOVerify && !boSigned && (
                        <>
                          <label>
                            ...
                            <input
                              value={boSigner}
                              onChange={(e) => setBoSigner(e.target.value)}
                            />
                          </label>
                          <button
                            className="primary"
                            disabled={!boSigner || !reportReconciliationReady}
                            onClick={() => setBoSigned(true)}
                          >
                            Approve & Sign as BO
                          </button>
                        </>
                    ...
                    <div className="signParty">
                      ...
                      <mark className={vendorSigned ? "green" : "yellow"}>
                        {vendorSigned
                          ? "SIGNED"
                          : boSigned
                            ? "MENUNGGU VENDOR"
                      ...
                      {canVendorConfirm && !vendorSigned && (
                        <>
                          ...
                          <button
                            ...
                            onClick={() => setVendorSigned(true)}
                          >
                            Approve & Sign as Vendor
                          </button>
                        </>
                      )}
                    </div>
                  ...
                  {!canBOVerify && !canVendorConfirm && (
                    <div className="info">
                      <b>Status laporan saja</b>
                      <br />
                      Role Anda dapat memantau status, tetapi tidak dapat
                      menandatangani sebagai BO maupun Vendor.
                    </div>
                  )}
          ...
          {tab === "master" && masterTab === "Master Lounge/Tenant" && (
            <>
              <div className="title actionTitle">
                ...
                {canManageMaster && (
                  <div>
                    <button
                      onClick={() =>
                        setMasterTableTarget("Master Lounge/Tenant")
                      }
                    >
                      Kelola Tabel
                    </button>
              ...
              {loungeNotice && (
                <Notice n={loungeNotice} close={() => setLoungeNotice(null)} />
              )}
              <MasterFilterBar
                query={masterQuery}
          ...
          {tab === "master" && masterTab === "Master Station" && (
            <article className="card tableCard">
              <div className="actionTitle miniHead">
                <div>
                  <h2>Master Station</h2>
                  <span>
                    Sumber resmi pilihan station, authority akun, dan local
                    time.
                  </span>
                </div>
                {canManageMaster && (
                  <div className="rowAct">
                    ...
                    <label className="uploadButton">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          const file = e.target.files?.[0];
                          if (file) void uploadStations(file);
                          e.target.value = "";
                        }}
                      />
                    </label>
              ...
              <MasterFilterBar
                ...
                value={masterSelect}
                setValue={setMasterSelect}
                options={[...new Set(stations.map((x) => x.utcLabel))]}
                value2={masterSelect2}
                setValue2={setMasterSelect2}
                options2={[...new Set(stations.map((x) => x.status))]}
                placeholder="Kode / nama station"
                label1="UTC Zone"
                ...
                count={
                  stations.filter(
                    (s) =>
                      ...
                      (masterSelect2 === "Semua" || s.status === masterSelect2),
                  ).length
                }
              />
              <div className="tableWrap">
                    ...
                    {stations
                      ...
                      .map((s) => (
                        <tr key={s.code}>
                          ...
                          <td>
                            <mark
                              className={s.status === "Aktif" ? "green" : "red"}
                            >
                              {s.status}
                            </mark>
                          </td>
                              ...
                              <div className="rowAct">
                                ...
                                <button
                                  ...
                                  disabled={
                                    ...
                                    lounges.some((l) => l.airport === s.code)
                                  }
                                  onClick={() =>
                                    askDelete(
                                      "Hapus station?",
                                      `${s.code} · ${s.name}`,
                                      async () => {
                                        await removeRecord("stations", s.code);
                                        setStations((xs) =>
                                          xs.filter((x) => x.code !== s.code),
                                        );
                                        setStationNotice({
                                          kind: "ok",
                                          text: `Station ${s.code} berhasil dihapus.`,
                                        });
                                      },
                                    )
                                  }
          ...
          {tab === "master" && masterTab === "Master Airline" && (
            <article className="card tableCard">
              <div className="actionTitle miniHead">
                <div>
                  <h2>Master Airline</h2>
                  <span>
                    Two-character IATA code for export, display, and
                    verifier-organization routing.
                  </span>
                </div>
                {canManageMaster && (
                  <div className="rowAct">
                    <button
                      onClick={() => setMasterTableTarget("Master Airline")}
                    >
                      Kelola Tabel
                    </button>
                    ...
                    <label className="uploadButton">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          const file = e.target.files?.[0];
                          if (file) void uploadAirlines(file);
                          e.target.value = "";
                        }}
                      />
                    </label>
              ...
              <MasterFilterBar
                ...
                setValue={setMasterSelect}
                options={[
                  ...new Set(airlines.map((x) => x.verifierOrganization)),
                ]}
                value2={masterSelect2}
                setValue2={setMasterSelect2}
                options2={[...new Set(airlines.map((x) => x.status))]}
                placeholder="Kode / nama airline"
                label1="Verifier Organization"
                label2="Airline Status"
                searchLabel="Search Airline"
                count={
                  airlines.filter(
                    (item) =>
                      `${item.code} ${item.name}`
                    ...
                    {airlines
                      ...
                      .map((airline) => (
                        <tr key={`${airline.code}-${airline.name}`}>
                          ...
                          <td>{airline.name}</td>
                          <td>{airline.verifierOrganization}</td>
                          <td>
                            <mark
                              className={
                                airline.status === "Active" ? "green" : "red"
                              }
                            >
                              {airline.status}
                            </mark>
                          ...
                          <td>
                            {canManageMaster ? (
                              <div className="rowAct">
                                <button
                                  onClick={() => {
                                    setEditingAirline(airline.code);
                                    setAirlineDraft({ ...airline });
                                    setShowAirlineForm(true);
                                  }}
                                >
                                  Update
                                ...
                                <button
                                  onClick={async () => {
                                    ...
                                    try {
                                      await saveRecord("airlines", {
                                        ...updated,
                                        id: airline.code,
                                      });
                                      setAirlines((rows) =>
                                        rows.map((x) =>
                                          x.code === airline.code ? updated : x,
                                        ),
                                      );
                                      setAirlineNotice({
                                        kind: "ok",
                                        text: `Status ${airline.code} berhasil diperbarui.`,
                                      });
                                    } catch (error) {
                                      setActionDialog({
                                        kind: "error",
                                        text:
                                          error instanceof Error
                                            ? error.message
                                            : "Status airline tidak dapat diperbarui.",
                                      });
                                    }
                                  }}
                                >
                                  ...
                                  onClick={() =>
                                    askDelete(
                                      ...
                                      async () => {
                                        ...
                                        setAirlineNotice({
                                          kind: "ok",
                                          text: `Airline ${airline.code} berhasil dihapus.`,
                                        });
                                      },
                                    )
                                  }
              ...
              <div className="info">
                <b>Export rule</b>
                <br />
                Operating Airline Code is derived from exactly the first two
                alphanumeric characters immediately before the numeric flight
                number. The master is used to validate the code and route
                partner verification; it is not required merely to split
                ORG/DEST.
              </div>
            </article>
          )}
          {tab === "master" && masterTab === "User & Role" && (
            <article className="card tableCard">
              <div className="actionTitle miniHead">
                ...
                {canManageMaster && (
                  <div className="rowAct">
                    <button onClick={() => setMasterTableTarget("User & Role")}>
                      Kelola Tabel
                    </button>
                    {role === "Super Admin" && (
                      <button onClick={() => setShowManageRole(true)}>
                        Kelola Role
                      </button>
                    )}
              ...
              {userUploadNotice && (
                <Notice
                  n={userUploadNotice}
                  close={() => setUserUploadNotice(null)}
                />
              )}
              <MasterFilterBar
                query={masterQuery}
                ...
                options2={[
                  ...new Set([
                    ...accounts.map((x) => x.station),
                    ...accounts.map((x) => x.status),
                  ]),
                ]}
                  ...
                  <thead>
                    <tr>
                      <SortTh
                        ...
                        sortKey="name"
                        current={userSort}
                        onSort={(key) => setUserSort((s) => nextSort(s, key))}
                      />
                      <SortTh
                        label="Role"
                        sortKey="role"
                  ...
                  <tbody>
                    {filteredAccounts.map((a) => (
                      <tr key={a.id}>
                        ...
                        <td>{a.role}</td>
                        <td>
                          {a.station === "ALL" ? "Seluruh BO" : a.station}
                        </td>
                        <td>{a.scope}</td>
                        <td>
                          <mark
                            className={a.status === "Aktif" ? "green" : "red"}
                          >
                            {a.status}
                          </mark>
                        </td>
                                  ...
                                  askDelete(
                                    ...
                                    async () => {
                                      ...
                                      try {
                                        ...
                                        setUserUploadNotice({
                                          kind: "ok",
                                          text: "Akun berhasil dinonaktifkan; histori dan audit tetap tersimpan.",
                                        });
                                      } catch (error) {
                                        setUserUploadNotice({
                                          kind: "error",
                                          text:
                                            error instanceof Error
                                              ? error.message
                                              : "Akun tidak dapat dinonaktifkan.",
                                        });
                                      }
                                    },
                                  )
          ...
          {tab === "master" && masterTab === "Access Entitlement" && (
            <article className="card">
              ...
              />
              {canManageMaster && (
                <div className="masterAction rowAct">
                  <button
                    onClick={() => setMasterTableTarget("Access Entitlement")}
                  >
                    Kelola Tabel
                  </button>
                  ...
                  <label className="uploadButton">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        const file = e.target.files?.[0];
                        if (file) void uploadEntitlements(file);
                        e.target.value = "";
                      }}
                    />
                  </label>
                  <button onClick={() => setShowEligibilityRules(true)}>
                    Kelola Eligibility Rules
                  </button>
                  <button onClick={() => setShowIntegrationStatus(true)}>
                    Status Integrasi
                  </button>
                  <button
                    className="primary"
              ...
              {entitlementNotice && (
                <Notice
                  n={entitlementNotice}
                  close={() => setEntitlementNotice(null)}
                />
              )}
              <MasterFilterBar
                query={masterQuery}
              ...
              <div className="partnerGrid">
                {filteredPartnerships.map((p) => (
                  <div key={p.id}>
                    ...
                    <small>
                      Verifier: {p.verifierOrganization} · Tier/Product:{" "}
                      {p.eligibleTiers}
                    </small>
                    <small>
                      Effective: {p.effectiveStart} — {p.effectiveEnd} ·
                      Station: {p.stationScope} · Version {p.version}
                    </small>
                    <small>
                      Payer/Price: {p.payer} · {p.priceRule}
                    </small>
                    ...
                    {canManageMaster && (
                      <div className="rowAct">
                        <button
                          onClick={() => {
                            ...
                            setPartnershipDraft({
                              ...
                              verifierOrganization: p.verifierOrganization,
                              eligibleTiers: p.eligibleTiers,
                              effectiveStart: p.effectiveStart,
                              effectiveEnd: p.effectiveEnd,
                              stationScope: p.stationScope,
                              payer: p.payer,
                              priceRule: p.priceRule,
                              companionRule: p.companionRule,
                              apiReferenceFields: p.apiReferenceFields,
                              version: p.version,
                            });
                            setShowPartnershipForm(true);
                          }}
                        ...
                        <button
                          ...
                          onClick={() =>
                            askDelete(
                              "Hapus access entitlement?",
                              `${p.type} · ${p.name}`,
                              async () => {
                                await removeRecord("entitlements", p.id);
                                setPartnerships((xs) =>
                                  xs.filter((x) => x.id !== p.id),
                                );
                                setEntitlementNotice({
                                  kind: "ok",
                                  text: `${p.name} berhasil dihapus.`,
                                });
                              },
                            )
                          }
            ...
            <article className="card">
              ...
              <div className="form">
                ...
                <label>
                  ...
                  <input
                    ...
                    min="5"
                    max="1440"
                    value={manualVerificationSla}
                    onChange={(e) =>
                      setManualVerificationSla(Number(e.target.value))
                    }
                  />
                </label>
                <label>
                  ...
                  <input
                    ...
                    min="1"
                    max="30"
                    value={evidenceBoRetention}
                    onChange={(e) =>
                      setEvidenceBoRetention(Number(e.target.value))
                    }
                  />
                </label>
                <label>
                  ...
                  <input
                    ...
                    min="1"
                    max="365"
                    value={evidenceAdminRetention}
                    onChange={(e) =>
                      setEvidenceAdminRetention(Number(e.target.value))
                    }
                  />
                </label>
              </div>
              ...
              <div className="rulePreview">
                ...
                <span>
                  ...
                  membership {memberMode} · manual verification SLA{" "}
                  {manualVerificationSla} minutes · evidence BO{" "}
                  {evidenceBoRetention} days / Super Admin{" "}
                  {evidenceAdminRetention} days
                </span>
              </div>
          ...
          {tab === "master" &&
            masterTab === "Portal Management" &&
            role === "Super Admin" && (
              <article className="card builderCard">
                <CardTitle
                  step="SUPER ADMIN NO-CODE CONTROL"
                  title="Portal Management"
                  right="SUPER ADMIN ONLY"
                />
                <div className="info">
                  <b>Source data remains protected.</b>
                  <br />
                  Core and custom fields are hidden or archived instead of
                  deleted. Changes are saved as display configuration so
                ...
                {portalSection === "Dashboard Manager" && (
                  <section className="portalManagerSection">
                    <div className="portalSectionHead">
                      <div>
                        <h2>Dashboard Manager</h2>
                        <p>
                          Atur siapa yang dapat membuka Dashboard serta widget
                    ...
                    <div className="dashboardRoleMatrix">
                      ...
                      <div>
                        {roleProfileSeed.map((profile) => (
                          <label key={profile.role}>
                            <input
                              type="checkbox"
                              checked={dashboardAllowedRoles.includes(
                                profile.role,
                              )}
                              onChange={(e) =>
                                setDashboardAllowedRoles((roles) =>
                                  e.target.checked
                                    ? [...new Set([...roles, profile.role])]
                                    : roles.filter(
                                        (item) => item !== profile.role,
                                      ),
                                )
                              }
                            />
                    ...
                    <div className="dashboardWidgetManager">
                      {dashboardWidgets.map((widget, index) => (
                        <div key={widget.id}>
                          <span className="dragHandle">⋮⋮</span>
                          <label className="widgetVisibility">
                            <input
                              type="checkbox"
                          ...
                          <div className="widgetNames">
                            <input
                              value={widget.titleId}
                              onChange={(e) =>
                                setDashboardWidgets((items) =>
                                  items.map((item) =>
                                    item.id === widget.id
                              ...
                              aria-label="Widget label Indonesia"
                            />
                            <input
                              ...
                              aria-label="Widget label English"
                            />
                          </div>
                          <div className="widgetRoles">
                            {dashboardAllowedRoles.map((allowedRole) => (
                              <label key={allowedRole}>
                                <input
                                  type="checkbox"
                                  checked={widget.roles.includes(allowedRole)}
                                  onChange={(e) =>
                                    setDashboardWidgets((items) =>
                                      items.map((item) =>
                                        item.id === widget.id
                ...
                {portalSection === "Menu & Table Manager" && (
                  <section className="portalManagerSection">
                    <div className="portalSectionHead">
                      <div>
                        <h2>Menu &amp; Table Manager</h2>
                        <p>
                          Ubah label, visibilitas, tipe field, dan urutan tanpa
                          menghapus data inti.
                        </p>
                      </div>
                    </div>
                    <div className="builderToolbar">
                      <FilterField label="Menu / Page / Table">
                        <SearchableSelect
                          ...
                          onChange={setBuilderSurface}
                          options={[
                            ...new Set(
                              builderItems.map((item) => item.surface),
                            ),
                          ]}
                          placeholder="Choose configuration surface"
                        />
                      </FilterField>
                      <div className="builderLegend">
                        <span>
                          <i className="coreDot" /> Core field
                        </span>
                        <span>
                          <i className="customDot" /> Custom field
                        </span>
                      </div>
                    </div>
                    <div className="schemaManager builderSchema">
                      {builderItems
                        .filter((item) => item.surface === builderSurface)
                        .map((item, index, visibleItems) => (
                          <div key={item.id}>
                            ...
                            <small>
                              {item.kind} ·{" "}
                              {item.locked ? "Core / protected" : "Custom"} ·
                              order {index + 1}
                            </small>
                            <div className="builderLabels">
                              <input
                                aria-label="Label Indonesia"
                                value={item.labelId}
                                onChange={(e) =>
                                  setBuilderItems((items) =>
                                    items.map((x) =>
                                      x.id === item.id
                                        ? { ...x, labelId: e.target.value }
                                        : x,
                                    ),
                                  )
                                }
                            ...
                            <div className="rowAct">
                              <button
                                disabled={index === 0}
                                onClick={() => moveBuilderItem(item.id, -1)}
                              >
                                ↑
                              </button>
                              <button
                    ...
                    <div className="builderAddPanel">
                      <div>
                        <b>Add Custom Field / Column</b>
                        <span>
                          Every new item requires both ID and EN labels before
                          it can be published.
                        </span>
                      </div>
                      <div className="form">
                        <label>
                          Target Surface
                          <SearchableSelect
                            value={builderDraft.surface}
                            onChange={(surface) =>
                              setBuilderDraft({ ...builderDraft, surface })
                            }
                            options={[
                              ...new Set(
                                builderItems.map((item) => item.surface),
                            ...
                            placeholder="Target surface"
                          />
                        </label>
                        <label>
                          Data Type
                          <select
                            value={builderDraft.kind}
                            onChange={(e) =>
                              setBuilderDraft({
                                ...builderDraft,
                                kind: e.target.value as BuilderItem["kind"],
                              })
                            }
                          >
                            {[
                        ...
                        <label>
                          ...
                          <input
                            ...
                            placeholder="Nama field/kolom"
                          />
                        </label>
                        <label>
                          Label EN
                          <input
                            value={builderDraft.labelEn}
                            onChange={(e) =>
                              setBuilderDraft({
                                ...builderDraft,
                      ...
                      <button
                        className="primary"
                        disabled={
                          !builderDraft.labelId.trim() ||
                          !builderDraft.labelEn.trim()
                        }
                        onClick={() => {
                          setBuilderItems((items) => [
                            ...items,
                          ...
                          setBuilderNotice(
                            `${builderDraft.labelId} / ${builderDraft.labelEn} added as a hidden-safe configurable field.`,
                          );
                          setBuilderDraft({
                            id: "",
                            surface: builderDraft.surface,
                            labelId: "",
                            labelEn: "",
                            kind: "Text",
                            visible: true,
                    ...
                    {builderNotice && (
                      <Notice
                        n={{ kind: "ok", text: builderNotice }}
                        close={() => setBuilderNotice("")}
                      />
                    )}
                    <div className="builderPublishBar">
                      <span>
                        <b>Draft</b> Review labels and order → Preview → Publish
                      ...
                      <div className="rowAct">
                        <button
                          onClick={() =>
                            setBuilderNotice(
                              "Preview ready. Hidden fields remain in source data and integrations.",
                            )
                          }
                        >
                          Preview
                        ...
                        <button
                          className="primary"
                          disabled={builderItems.some(
                            (item) =>
                              !item.labelId.trim() || !item.labelEn.trim(),
                          )}
                          onClick={() =>
                            setBuilderNotice(
                              "Configuration version published and recorded in Activity Log simulation.",
                            )
                          }
                        >
                          Publish Version
                ...
                {portalSection === "Page & Text Editor" && (
                  <section className="portalManagerSection">
                    <div className="portalSectionHead">
                      <div>
                        <h2>Page &amp; Text Editor</h2>
                        <p>
                          Kelola label dan deskripsi pendek. Teks operasional
                          tetap melalui draft, preview, dan publish.
                        </p>
                      </div>
                    </div>
                    <div className="pageTextEditor">
                      {builderItems
                    ...
                    <div className="builderPublishBar">
                      <span>
                        <b>Draft text</b> Preview seluruh halaman sebelum
                        publikasi.
                      </span>
                      <button
                        className="primary"
                        onClick={() =>
                          setBuilderNotice(
                            "Text configuration published in prototype.",
                          )
                        }
                      >
                ...
                {portalSection === "Translation Manager" && (
                  <section className="portalManagerSection">
                    <div className="portalSectionHead">
                      <div>
                        <h2>Translation Manager</h2>
                        <p>
                          Aktifkan bahasa Inggris hanya setelah seluruh
                          translation key lulus review.
                        </p>
                      </div>
                    </div>
                    <div className="translationControl">
                      <label className="switchLine">
                        <input
                          type="checkbox"
                          checked={languageFeatureEnabled}
                          onChange={(e) => {
                            setLanguageFeatureEnabled(e.target.checked);
                            if (!e.target.checked) setLanguage("ID");
                          }}
                        />
                        <span>
                          <b>
                          ...
                          <small>
                            Jika nonaktif, tombol bahasa disembunyikan untuk
                            seluruh pengguna.
                          </small>
                        </span>
                      </label>
                      <div className="translationSummary">
                        <div>
                          <b>
                            {
                              builderItems.filter(
                  ...
                  <thead>
                    <tr>
                      <SortTh
                        ...
                        onSort={(key) =>
                          setActivitySort((s) => nextSort(s, key))
                        }
                      />
                      <SortTh
                        label="User"
                  ...
                  <tbody>
                    {filteredActivity.map((a) => (
                      <tr key={a.id}>
                        ...
                        <td>{a.scope}</td>
                        <td>
                          <span className="statusText">Audit record</span>
                        </td>
                      </tr>
                    ))}
                  </tbody>
            ...
            <>
              <div className="title actionTitle">
                ...
                <div className="scopeBadge">
                  {isGlobalAdmin ? "Seluruh Station" : `Station ${station}`}
                </div>
              </div>
              <SubTabs
              ...
              {flightTab === "Seasonal Schedule" && (
                <article className="card seasonCard">
                  ...
                  <button
                    className="primary"
                    onClick={() => void generateSeasonalSchedule()}
                  >
              ...
              {flightTab === "Irregularity" && (
                <article className="card">
                  ...
                  <button
                    className="primary"
                    onClick={() => void saveIrregularity()}
                  >
                    Simpan Irregularity
                  </button>
                  {irregularityNotice && (
                    <Notice
                      n={irregularityNotice}
                      close={() => setIrregularityNotice(null)}
                    />
                  )}
                </article>
              )}
              <div className="flightTools">
                ...
                <label
                  className="uploadButton passengerFallbackButton"
                  title="Digunakan hanya ketika integrasi Passenger List/DCS belum tersedia atau sedang terganggu."
                >
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const f = e.target.files?.[0];
                      if (f) void previewPassengerList(f);
                      e.target.value = "";
                    }}
                  />
                </label>
              ...
              <div className="fallbackExplanation">
                ...
                <span>
                  ...
                  belum terintegrasi atau koneksinya terganggu. File CSV/XLSX
                  ditampilkan sebagai preview untuk pengecekan DOT, flight,
                  duplicate, dan mapping kolom sebelum data disimpan.
                </span>
              </div>
              {flightNotice && (
                <Notice n={flightNotice} close={() => setFlightNotice(null)} />
              )}
              {passengerImportNotice && (
                <Notice
                  n={{
                    kind: passengerImportNotice.startsWith("Preview")
                      ? "ok"
                      : "warn",
                    text: passengerImportNotice,
                  }}
                ...
                <div className="filters threeFilters">
                  <FilterField label="Flight Date">
                    <input
                      ...
                      onChange={(e) => setFlightDateFilter(e.target.value)}
                    />
                  </FilterField>
                  <FilterField label="Origin Station">
                    <SearchableSelect
                  ...
                  <FilterField label="Search Flight">
                    <input
                      ...
                      placeholder="Flight / rute / capacity"
                    />
                  </FilterField>
                  <span>
                    {shownFlights.length} data ·{" "}
                    {flightDateFilter || "semua tanggal"}
                  </span>
                </div>
                <div className="tableWrap">
                  <table>
                    <thead>
                      <tr>
                        <SortTh
                          ...
                          current={flightSort}
                          onSort={(key) =>
                            setFlightSort((s) => nextSort(s, key))
                          }
                        />
                        <SortTh
                          label="Rute"
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    setFlights((rows) =>
                                      rows.map((item) =>
                                        item.id === f.id
                                          ? { ...item, etd: e.target.value }
                                          : item,
                                      ),
                                    )
                                  }
                                  onBlur={(e) =>
                                    void persistFlightChange(f.id, {
                                      etd: e.target.value,
                                    })
                                  }
                                />
                                ...
                                <div className="rowAct">
                                  ...
                                  <button
                                    ...
                                    onClick={() =>
                                      askDelete(
                                        "Hapus penerbangan?",
                                        `${f.flight} ${f.origin}–${f.destination} · ${f.date}`,
                                        async () => {
                                          await removeRecord("flights", f.id);
                                          setFlights((xs) =>
                                            xs.filter((x) => x.id !== f.id),
                                          );
                                          setFlightNotice({
                                            kind: "ok",
                                            text: `${f.flight} berhasil dihapus.`,
                                          });
                                        },
                                      )
                                    }
      ...
      {actionDialog && (
        <div className="back" onMouseDown={() => setActionDialog(null)}>
          <section
            className="modal actionDialog"
            onMouseDown={(event) => event.stopPropagation()}
            role="alertdialog"
            aria-modal="true"
          >
            <div className={`confirmIcon ${actionDialog.kind}`}>
              {actionDialog.kind === "ok" ? "✓" : "!"}
            </div>
            <h2>
              {actionDialog.kind === "ok"
                ? "Berhasil"
                : actionDialog.kind === "warn"
                  ? "Perhatian"
      ...
      {showInbox && (
        <div className="back" onMouseDown={() => setShowInbox(false)}>
          <section
            className="modal inboxModal"
            onMouseDown={(e) => e.stopPropagation()}
          >
            <div className="modalHead">
              <div>
                <span>INBOX &amp; NOTIFICATIONS</span>
                <h2>Aktivitas untuk Anda</h2>
              </div>
        ...
        >
          <form
            ...
            onSubmit={async (e) => {
              ...
              if (
                ...
                setProfileNotice(
                  "Password baru minimal 8 karakter dan konfirmasinya harus sama.",
                );
                return;
              }
              if (!firebaseUser?.email) {
                setProfileNotice("Sesi Firebase tidak aktif.");
                return;
              }
              try {
                await reauthenticateWithCredential(
                  firebaseUser,
                  EmailAuthProvider.credential(firebaseUser.email, oldPassword),
                );
                await updatePassword(firebaseUser, newPasswordValue);
                await completePasswordChange(firebaseUser);
                setCurrentAccount((account) =>
                  account ? { ...account, mustChangePassword: false } : account,
                );
                setOldPassword("");
                setNewPasswordValue("");
          ...
          >
            ...
            <div className="profileIdentity">
              <b>{currentAccount.name}</b>
              <span>
                {currentAccount.role} · {currentAccount.scope}
              </span>
            </div>
            <div className="form">
              <label className="full">
              ...
              <div
                className={
                  profileNotice.includes("berhasil")
                    ? "notice ok compactNotice"
                    : "notice error compactNotice"
                }
              >
                {profileNotice}
              </div>
      ...
      {evidenceVisitor && (
        <div className="back" onMouseDown={() => setEvidenceVisitor(null)}>
          ...
          >
            <div className="modalHead">
              <div>
                <span>DISPUTE &amp; CORRECTION</span>
                <h2>Koreksi dan Kirim Evidence</h2>
              </div>
              <button type="button" onClick={() => setEvidenceVisitor(null)}>
                ×
              </button>
            </div>
            <div className="info">
              <b>
                {evidenceVisitor.name} · {evidenceVisitor.flight}
              </b>
              <br />
              {evidenceVisitor.boReason}
            </div>
            <div className="form">
              <label>
                Evidence Type
                <select
                  value={evidenceType}
                  onChange={(e) =>
                    setEvidenceType(e.target.value as Visitor["evidenceType"])
                  }
                >
            ...
            <label className="evidenceUpload">
              Lampiran evidence
              <input
                type="file"
              ...
              />
              <span>{evidenceName || "PDF/JPG/PNG, pilih satu dokumen"}</span>
            </label>
            <div className="modalActions">
              <button type="button" onClick={() => setEvidenceVisitor(null)}>
                Batal
              </button>
              <button className="primary" disabled={!evidenceName}>
                Kirim Ulang ke Verifier
              </button>
            </div>
          </form>
        </div>
      ...
      {showStationForm && canManageMaster && (
        <div className="back" onMouseDown={() => setShowStationForm(false)}>
          ...
          >
            <div className="modalHead">
              <div>
                <span>MASTER STATION</span>
                <h2>{editingStation ? "Update" : "Tambah"} Station</h2>
              </div>
            ...
            <div className="form">
              <label>
                ...
                <input
                  maxLength={3}
                  value={stationDraft.code}
                  readOnly={Boolean(editingStation)}
                  onChange={(e) =>
                    setStationDraft({
                      ...stationDraft,
              ...
              <label>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setStationDraft({ ...stationDraft, name: e.target.value })
                  }
                />
              </label>
              <label>
                Time Zone
                <select
                  value={`${stationDraft.timeZone}|${stationDraft.utcLabel}`}
                  onChange={(e) => {
                    const [timeZone, utcLabel] = e.target.value.split("|");
                    setStationDraft({ ...stationDraft, timeZone, utcLabel });
                  }}
                >
                  <option value="Asia/Jakarta|UTC+7">
                    Asia/Jakarta — UTC+7
                  </option>
                  <option value="Asia/Makassar|UTC+8">
                    Asia/Makassar — UTC+8
                  </option>
                  <option value="Asia/Jayapura|UTC+9">
                    Asia/Jayapura — UTC+9
                  </option>
                </select>
              </label>
      ...
      {showAirlineForm && canManageMaster && (
        <div className="back" onMouseDown={() => setShowAirlineForm(false)}>
          <form
            className="modal"
            onMouseDown={(e) => e.stopPropagation()}
            onSubmit={saveAirline}
          >
            <div className="modalHead">
              <div>
                <span>MASTER AIRLINE</span>
                <h2>{editingAirline ? "Update" : "Tambah"} Airline</h2>
              </div>
              <button type="button" onClick={() => setShowAirlineForm(false)}>
                ×
              </button>
            </div>
            <div className="form">
              <label>
                ...
                <input
                  maxLength={2}
                  value={airlineDraft.code}
                  readOnly={Boolean(editingAirline)}
                  onChange={(e) =>
                    setAirlineDraft({
                      ...airlineDraft,
                      code: e.target.value.toUpperCase(),
              ...
              <label>
                Status
                <select
                  value={airlineDraft.status}
                  onChange={(e) =>
                    setAirlineDraft({
                      ...airlineDraft,
                      status: e.target.value as Airline["status"],
                    })
                  }
                >
              ...
              <label className="full">
                Nama Airline
                <input
                  value={airlineDraft.name}
                  onChange={(e) =>
                    setAirlineDraft({ ...airlineDraft, name: e.target.value })
                  }
              ...
              <label className="full">
                ...
                <input
                  value={airlineDraft.verifierOrganization}
                  onChange={(e) =>
                    setAirlineDraft({
                      ...airlineDraft,
                      verifierOrganization: e.target.value,
                    })
                  }
                  placeholder="Garuda Indonesia / Partner Airline"
                />
              </label>
            </div>
            <div className="modalActions">
      ...
      {showManageTable && role === "Super Admin" && (
        <div className="back" onMouseDown={() => setShowManageTable(false)}>
          ...
          >
            <div className="modalHead">
              <div>
                <span>{manageTableContext.toUpperCase()} CONFIGURATION</span>
                <h2>Manage Table — {manageTableContext}</h2>
              </div>
              <button onClick={() => setShowManageTable(false)}>×</button>
            </div>
            {manageTableContext === "Verification" ? (
              <>
                <div className="lockedColumns">
                  <b>Verification-critical fields</b>
                  <span>
                    Passenger, Flight, Date of Travel, FFP/Membership Number,
                    Tier/Product, Verifier Organization, Evidence, and decision
                    status are available to authorized verifiers. Row-level
                ...
                <div className="schemaManager">
                  {[
                    ...verificationColumns,
                    ...verificationColumnOptions
                      .map((option) => option.key)
                      .filter((key) => !verificationColumns.includes(key)),
                  ].map((key) => {
                    const column = verificationColumnOptions.find(
                      ...
                      <div key={column.key}>
                        ...
                        <label>
                          <input
                            ...
                            onChange={(e) =>
                              setVerificationColumns((columns) =>
                                e.target.checked
                                  ? [...columns, column.key]
                                  : columns.filter((x) => x !== column.key),
                              )
                            }
                          />
                          {column.label}
                        ...
                        <small>
                          {visibleIndex >= 0
                            ? `Display order ${visibleIndex + 1}`
                            : "Hidden — source data retained"}
                        </small>
                        <div className="rowAct">
                          <button
                            ...
                            onClick={() =>
                              setVerificationColumns((columns) => {
                                const copy = [...columns];
                                [copy[visibleIndex - 1], copy[visibleIndex]] = [
                                  copy[visibleIndex],
                                  copy[visibleIndex - 1],
                                ];
                                return copy;
                          ...
                          <button
                            disabled={
                              visibleIndex < 0 ||
                              visibleIndex === verificationColumns.length - 1
                            }
                            onClick={() =>
                              setVerificationColumns((columns) => {
                                const copy = [...columns];
                                [copy[visibleIndex], copy[visibleIndex + 1]] = [
                                  copy[visibleIndex + 1],
                                  copy[visibleIndex],
                                ];
                                return copy;
                ...
                <div className="modalActions">
                  <button onClick={() => setShowManageTable(false)}>
                    Cancel
                  </button>
                  <button
                    className="primary"
              ...
              <>
                <div className="lockedColumns">
                  <b>Core System Fields</b>
                  <span>
                    Visitor ID, Date of Travel, Scan Timestamp, Station,
                    Lounge/Tenant, Passenger, Flight, Sequence, Verification
                    Status, dan Audit Trail tetap terkunci. Kolom inti dapat
                    disembunyikan di report, tetapi tidak dihapus dari data.
                  </span>
                </div>
                <div className="customColumnList">
                  {customColumns.length ? (
                    customColumns.map((column, index) => (
                      <div key={column.id}>
                        ...
                        <div className="rowAct columnActions">
                          ...
                          <button
                            onClick={() => {
                              setEditingCustomColumn(column.id);
                              setCustomColumnDraft({ ...column });
                            }}
                          >
                            Edit
                          </button>
                    ...
                    <div className="empty">Belum ada custom column.</div>
                  )}
                </div>
                <div className="form columnBuilder">
                  <label>
                    ...
                    <input
                      ...
                      placeholder="Contoh: Flight & DOT"
                    />
                  </label>
                  <label>
                    Tipe Data
                    <select
                      value={customColumnDraft.type}
                      onChange={(e) =>
                        setCustomColumnDraft({
                          ...customColumnDraft,
                          type: e.target.value as CustomColumn["type"],
                        })
                      }
                    >
                      {["Text", "Number", "Date", "Currency", "Calculated"].map(
                        (x) => (
                          <option key={x}>{x}</option>
                        ),
                      )}
                  ...
                  <label className="full">
                    ...
                    <textarea
                      rows={3}
                      value={customColumnDraft.formula}
                      onChange={(e) =>
                        setCustomColumnDraft({
                          ...customColumnDraft,
                      ...
                      placeholder="Contoh: CONCAT([Origin], '–', [Destination])"
                    />
                  </label>
                </div>
                <div className="formulaBuilderTools">
                  ...
                  <label>
                    ...
                    <select
                      value=""
                      onChange={(e) => {
                        if (e.target.value) appendFormula(`${e.target.value}(`);
                      }}
                    >
                  ...
                  <div className="operatorPad">
                    ...
                    {formulaOperators.map((operator) => (
                      <button
                        type="button"
                        key={operator}
                        onClick={() => appendFormula(operator)}
                      >
                        {operator}
                      </button>
                    ))}
                ...
                <small className="formulaHelp">
                  Gunakan field yang tersedia dan operator aman. Fungsi: CONCAT,
                  SQRT/akar kuadrat, ABS, ROUND, MIN, MAX, dan POWER.
                </small>
                <div className="formulaPreview">
                  <b>Preview</b>
                  <span>
                    {shown[0]
                      ? customValue(shown[0], customColumnDraft)
                      : "Preview akan muncul ketika Visitor List memiliki data."}
                  </span>
                </div>
                <div className="modalActions">
                  <button
                  ...
                  <button
                    className="primary"
                    disabled={
                      !customColumnDraft.label.trim() ||
                      !customColumnDraft.formula.trim()
                    }
                    onClick={() => {
                      setCustomColumns((xs) =>
                        editingCustomColumn
                          ? xs.map((x) =>
                              x.id === editingCustomColumn
                                ? {
                                    ...customColumnDraft,
                                    id: editingCustomColumn,
                                  }
                                : x,
                            )
                          : [
                              ...xs,
                              { ...customColumnDraft, id: crypto.randomUUID() },
                            ],
                      );
                      setEditingCustomColumn(null);
                      setCustomColumnDraft({
                  ...
                  >
                    {editingCustomColumn ? "Update & Confirm" : "Add & Confirm"}
                  </button>
                </div>
              </>
            )}
      ...
      {showManageReport && canManageMaster && (
        <div className="back" onMouseDown={() => setShowManageReport(false)}>
          ...
          >
            <div className="modalHead">
              <div>
                <span>RECONCILIATION REPORT CONFIGURATION</span>
                <h2>Manage Report</h2>
              </div>
              <button onClick={() => setShowManageReport(false)}>×</button>
            </div>
            <div className="form">
              <label className="full">
                Judul Laporan
            ...
            <div className="reportConfigGrid">
              <div>
                ...
                {[
                  ...
                  <label key={item}>
                    <input
                      type="checkbox"
                      checked={reportConfig.metadata.includes(item)}
                      onChange={(e) =>
                        setReportConfig({
                          ...reportConfig,
                          metadata: e.target.checked
                            ? [...reportConfig.metadata, item]
                            : reportConfig.metadata.filter((x) => x !== item),
                        })
                      }
                    />
                    {item}
              ...
              <div>
                <b>Kolom Tabel</b>
                {reportColumnOptions.map((item) => (
                  <label key={item.key}>
                    <input
                      type="checkbox"
                      checked={reportConfig.columns.includes(item.key)}
                      onChange={(e) =>
                        setReportConfig({
                          ...reportConfig,
                          columns: e.target.checked
                            ? [...reportConfig.columns, item.key]
                            : reportConfig.columns.filter(
                                (x) => x !== item.key,
                              ),
                        })
                      }
            ...
            <label className="costToggle configCost">
              <input
                type="checkbox"
                checked={reportConfig.includeCost}
                onChange={(e) =>
            ...
            <div className="reportPreview">
              ...
              <b>{reportConfig.title || "Reconciliation Report"}</b>
              <span>
                {reportConfig.metadata.join(" · ") || "Tanpa metadata"}
              </span>
              <small>
                {reportConfig.columns.length} kolom dipilih · hanya confirmed
                visitor
              </small>
            </div>
            <div className="modalActions">
              <button onClick={() => setShowManageReport(false)}>Batal</button>
              <button
                className="primary"
                disabled={
                  !reportConfig.title.trim() || !reportConfig.columns.length
                }
                onClick={() => setShowManageReport(false)}
              >
                Simpan & Konfirmasi
              </button>
            </div>
          ...
          >
            <div className="modalHead">
              <div>
                ...
                <h2>Manage Table — {masterTableTarget}</h2>
              </div>
              <button onClick={() => setMasterTableTarget(null)}>×</button>
            </div>
            <div className="lockedColumns">
              <b>Core System Fields</b>
              <span>
                Primary key, relationship keys, authority scope, verification
                status, and audit fields are protected. Display columns may be
                shown, hidden, or reordered without deleting source data.
              </span>
            </div>
            <div className="schemaManager">
              {(masterTableTarget === "Master Lounge/Tenant"
                ? [
                    "Station",
                    "Lounge/Provider",
                    "Type",
                ...
                : masterTableTarget === "Master Station"
                  ? ["IATA Code", "Station Name", "Time Zone", "UTC", "Status"]
                  : masterTableTarget === "Master Airline"
                    ? [
                        "2-Letter Code",
                        "Airline",
                        "Verifier Organization",
                ...
                <div key={field}>
                  ...
                  <small>Display order {index + 1}</small>
                  <div className="rowAct">
            ...
            <div className="modalActions">
              <button onClick={() => setMasterTableTarget(null)}>Cancel</button>
              <button
                className="primary"
                onClick={() => setMasterTableTarget(null)}
              >
                Save & Confirm
              </button>
            </div>
      ...
      {showManageRole && role === "Super Admin" && (
        <div className="back" onMouseDown={() => setShowManageRole(false)}>
          ...
          >
            <div className="modalHead">
              <div>
                <span>AUTHORITY CONFIGURATION</span>
                <h2>Manage Role & Permission</h2>
              </div>
              <button onClick={() => setShowManageRole(false)}>×</button>
            </div>
            <div className="info">
              <b>Only Super Admin can change authority.</b>
              <br />
              Permissions are evaluated together with organization, station,
              airline, program, and lounge scope. All changes are versioned in
              Activity Log.
            </div>
            <div className="tableWrap permissionMatrix">
              <table>
                <thead>
                  <tr>
                    <th>Role</th>
            ...
            <div className="modalActions">
              <button onClick={() => setShowManageRole(false)}>Cancel</button>
              <button
                className="primary"
                onClick={() => setShowManageRole(false)}
              >
                Save Permission Version
              </button>
            </div>
          </section>
        </div>
      ...
      {showIntegrationStatus && canManageMaster && (
        <div
          className="back"
          onMouseDown={() => setShowIntegrationStatus(false)}
        >
          <section
            className="modal integrationModal"
            onMouseDown={(e) => e.stopPropagation()}
          >
            <div className="modalHead">
              <div>
                <span>IT INTEGRATION READINESS</span>
                <h2>Integration Status</h2>
              </div>
              <button onClick={() => setShowIntegrationStatus(false)}>×</button>
            </div>
            ...
            <div className="info">
              <b>Production setup is completed by Tim IT.</b>
              <br />
              Secrets and endpoint URLs belong in server-side environment
              variables. The frontend calls a common connector contract; it must
              never store corporate credentials.
            </div>
            <div className="modalActions">
              <button
                className="primary"
      ...
      {showEligibilityRules && canManageMaster && (
        <div
          className="back"
          onMouseDown={() => setShowEligibilityRules(false)}
        >
          <section
            className="modal wideModal"
            onMouseDown={(e) => e.stopPropagation()}
          >
            <div className="modalHead">
              <div>
                <span>VERSIONED BUSINESS RULE</span>
                <h2>Manage Eligibility Rules</h2>
              </div>
              <button onClick={() => setShowEligibilityRules(false)}>×</button>
            </div>
            <div className="info">
              <b>
                Admin may publish operational eligibility rules without Super
                Admin approval.
              </b>
              <br />
              Each change creates a new effective-dated version and audit
              record. Use Test Rule before publishing.
            </div>
            <div className="tableWrap">
              <table>
                <thead>
                ...
                <tbody>
                  {partnerships.map((p) => (
                    <tr key={p.id}>
                      <td>
                        <b>{p.name}</b>
                        <small>{p.eligibleTiers}</small>
                      </td>
                      <td>
                        {p.effectiveStart}
                        <small>{p.effectiveEnd}</small>
                      </td>
                      <td>{p.stationScope}</td>
                      <td>{p.apiReferenceFields}</td>
                      <td>{p.verifierOrganization}</td>
                      <td>
                        {p.payer}
                        <small>{p.priceRule}</small>
                      </td>
                      <td>{p.companionRule}</td>
                      <td>v{p.version}</td>
                    </tr>
                  ))}
                </tbody>
            ...
            <div className="modalActions">
              <button onClick={() => setShowEligibilityRules(false)}>
                Cancel
              </button>
              ...
              <button
                ...
                onClick={() => {
                  setPartnerships((xs) =>
                    xs.map((x) => ({ ...x, version: x.version + 1 })),
                  );
      ...
      {deleteRequest && (
        <div className="back" onMouseDown={() => setDeleteRequest(null)}>
          ...
          >
            ...
            <h2>{deleteRequest.title}</h2>
            <p>{deleteRequest.message}</p>
            <small>Pastikan target dan dampak tindakan sudah benar.</small>
            <div className="modalActions">
              <button onClick={() => setDeleteRequest(null)}>Batal</button>
              <button
                className="danger"
                onClick={async () => {
                  try {
          ...
          >
            <div className="modalHead">
              <div>
                ...
                <h2>{editingUser ? "Update" : "Tambah"} User</h2>
              </div>
            ...
            <div className="form">
              ...
              <label>
                ...
                <select
                  ...
                  onChange={(e) => {
                    const nextRole = e.target.value as Account["role"];
                    const globalRole = [
                      "Super Admin",
                      "Admin",
                      "HO Admin",
                ...
                >
                  {roleProfileSeed
                    .filter(
                      (x) => role === "Super Admin" || x.role !== "Super Admin",
                    )
                    .map((x) => (
              ...
              <label>
                ...
                >
                  <option value="ALL">ALL — Seluruh Station</option>
                  {stations
              ...
              <label className="full">
                Authority
                <textarea
                  value={`${roleProfileSeed.find((item) => item.role === userDraft.role)?.scope || "Configured authority"} · ${userDraft.station === "ALL" ? "Seluruh Station" : `Station ${userDraft.station}`}`}
                  readOnly
                />
              </label>
              <label>
                Organization / Unit
                <input
                  value={userDraft.organization}
                  onChange={(e) =>
                    setUserDraft({ ...userDraft, organization: e.target.value })
                  }
                  placeholder="HO Ancillary / Korean Air / Lounge CGK"
                />
              </label>
              <label className="full">
                Verification Scope
                <input
                  value={userDraft.verificationScopes.join(", ")}
                  onChange={(e) =>
                    setUserDraft({
                      ...userDraft,
                      verificationScopes: e.target.value
                        .split(",")
                        .map((x) => x.trim())
                        .filter(Boolean),
                    })
                  }
                  placeholder="Program, airline, category"
                />
              </label>
              <label>
                Status
            ...
            <div className="modalActions">
              ...
              <button className="primary" disabled={savingUser}>
                {savingUser ? "Menyimpan..." : "Simpan & Konfirmasi"}
              </button>
            </div>
          </form>
        </div>
      ...
      {showPartnershipForm && canManageMaster && (
        <div className="back" onMouseDown={() => setShowPartnershipForm(false)}>
          ...
          >
            <div className="modalHead">
              <div>
                <span>ENTITLEMENT MASTER</span>
                <h2>
                  {editingPartnership ? "Update" : "Tambah"} Produk / Agreement
                </h2>
              </div>
              <button
                type="button"
            ...
            <div className="form">
              <label>
                ...
                >
                  ...
                  <option>EMD</option>
                  <option>Paid Access</option>
                </select>
              </label>
              <label>
                Status
                <select
                  value={partnershipDraft.status}
                  onChange={(e) =>
                    setPartnershipDraft({
                      ...partnershipDraft,
              ...
              <label className="full">
                Nama Produk / Agreement
                <input
                  value={partnershipDraft.name}
                  onChange={(e) =>
                    setPartnershipDraft({
                      ...partnershipDraft,
                      name: e.target.value,
              ...
              <label className="full">
                Referensi / Ketentuan
                <input
                  value={partnershipDraft.reference}
                  onChange={(e) =>
                    setPartnershipDraft({
                      ...partnershipDraft,
              ...
              <label>
                Eligible Tier / Product
                <input
                  value={partnershipDraft.eligibleTiers}
                  onChange={(e) =>
                    setPartnershipDraft({
                      ...partnershipDraft,
                      eligibleTiers: e.target.value,
                    })
                  }
                />
              </label>
              <label>
                Verifier Organization
                <input
                  value={partnershipDraft.verifierOrganization}
                  onChange={(e) =>
                    setPartnershipDraft({
                      ...partnershipDraft,
                      verifierOrganization: e.target.value,
              ...
              <label>
                ...
                <input
                  type="date"
                  value={partnershipDraft.effectiveStart}
                  onChange={(e) =>
                    setPartnershipDraft({
                      ...partnershipDraft,
              ...
              <label>
                ...
                <input
                  type="date"
                  value={partnershipDraft.effectiveEnd}
                  onChange={(e) =>
                    setPartnershipDraft({
                      ...partnershipDraft,
              ...
              <label>
                Station / Lounge Scope
                <input
                  value={partnershipDraft.stationScope}
                  onChange={(e) =>
                    setPartnershipDraft({
                      ...partnershipDraft,
                      stationScope: e.target.value,
                    })
                  }
                />
              </label>
              ...
              <label>
                Price Rule
                <input
                  value={partnershipDraft.priceRule}
                  onChange={(e) =>
                    setPartnershipDraft({
                      ...partnershipDraft,
                      priceRule: e.target.value,
                    })
                  }
                />
              </label>
              <label>
                Companion Rule
                <input
                  value={partnershipDraft.companionRule}
                  onChange={(e) =>
                    setPartnershipDraft({
                      ...partnershipDraft,
                      companionRule: e.target.value,
                    })
                  }
                />
              </label>
              <label className="full">
                ...
                <input
                  value={partnershipDraft.apiReferenceFields}
                  onChange={(e) =>
                    setPartnershipDraft({
                      ...partnershipDraft,
                      apiReferenceFields: e.target.value,
                    })
                  }
                  placeholder="memberNumber,tier,status"
                />
              </label>
              <div className="full rolePicker">
                <b>Role yang dapat menggunakan</b>
                {roleProfileSeed.map((x) => (
                  <label key={x.role}>
                    <input
                      type="checkbox"
                      checked={partnershipDraft.allowedRoles.includes(x.role)}
                      onChange={(e) =>
                        setPartnershipDraft({
                          ...partnershipDraft,
                          allowedRoles: e.target.checked
                            ? [...partnershipDraft.allowedRoles, x.role]
                            : partnershipDraft.allowedRoles.filter(
                                (y) => y !== x.role,
                              ),
                        })
                      }
              ...
              {role === "Lounge Officer" && (
                <button
                  ...
                  onClick={() => {
                    ...
                    setNotice({
                      kind: "warn",
                      text: "Exceptional access request sent to Lounge Manager. Passenger remains pending and evidence is required.",
                    });
                  }}
                >
                  Request Exceptional Access
                </button>
              )}
              {role === "Lounge Manager" && (
                <button
                  ...
                  onClick={() => {
                    ...
                    setNotice({
                      kind: "warn",
                      text: "Exceptional Access Granted – Final Verification Pending. Upload Boarding Pass or Membership Card evidence.",
                    });
                  }}
                >
          ...
          <form
            ...
            onSubmit={async (e) => {
              ...
              try {
                ...
                setActionDialog({
                  kind: "ok",
                  text: "Data visitor berhasil diperbarui.",
                });
              } catch (error) {
                setActionDialog({
                  kind: "error",
                  text:
                    error instanceof Error
                      ? error.message
                      : "Data visitor tidak dapat diperbarui.",
                });
              }
            }}
          >
            ...
            <div className="form">
              ...
              <label>
                ...
                <input
                  type="date"
                  value={edit.travelDate || edit.date}
                  onChange={(e) =>
                    setEdit({
                      ...edit,
                      travelDate: e.target.value,
...
function DonutChart({
  ...
  const stops = items
    ...
    .join(", ");
  return (
    <div className={`donutChart ${compact ? "compact" : ""}`}>
      <div
        className="donutGraphic"
        style={{ background: total ? `conic-gradient(${stops})` : "#e4eef0" }}
        role="img"
        aria-label={`${centerLabel}: ${total.toLocaleString("id-ID")}`}
      >
        <span>
          ...
          {items.map(([name, value], index) => {
            const content = (
              <>
                ...
                <span>{name}</span>
                <b>{value.toLocaleString("id-ID")}</b>
                <small>
            ...
            return onSelect ? (
              <button type="button" key={name} onClick={() => onSelect(name)}>
                {content}
              </button>
            ) : (
...
function MasterFilterBar({
  ...
  return (
    <div className="filters masterFilters threeFilters">
      <FilterField label={label1}>
        <SearchableSelect
          value={value}
          onChange={setValue}
          options={["Semua", ...options.filter((x) => x && x !== "Semua")]}
          placeholder={label1}
        />
      </FilterField>
      <FilterField label={label2}>
        <SearchableSelect
          value={value2}
          onChange={setValue2}
          options={["Semua", ...options2.filter((x) => x && x !== "Semua")]}
          placeholder={label2}
        />
      </FilterField>
...
function SearchableSelect({
  ...
  const id = useId(),
    [textValue, setTextValue] = useState(value),
  ...
  function commit(next: string) {
    const match = cleanOptions.find(
      (x) => x.toLowerCase() === next.trim().toLowerCase(),
    );
    if (match) {
      onChange(match);
      setTextValue(match);
  ...
  const query =
    open && textValue === value ? "" : textValue.trim().toLowerCase();
  const filtered = cleanOptions.filter(
    (x) => !query || x.toLowerCase().includes(query),
  );
  return (
    <div className={`searchableSelect ${open ? "open" : ""}`} id={id}>
      <input
        value={textValue}
        disabled={disabled}
        placeholder={placeholder}
      ...
      <button
        ...
        tabIndex={-1}
        disabled={disabled}
        aria-label={`Buka pilihan ${placeholder}`}
      ...
      {open && !disabled && (
        <div className="searchableOptions" id={`${id}-options`} role="listbox">
          {filtered.length ? (
            filtered.map((option) => (
              <button
                type="button"
            ...
            <span>Tidak ada pilihan yang sesuai</span>
          )}
        </div>
      )}
    </div>
...
function VerificationPanel({
  ...
  const [checked, setChecked] = useState<string[]>([]),
    ...
    [decisionNotice, setDecisionNotice] = useState<InlineNotice | null>(null);
  const displayVisitors = sortData(
    visitors,
    sort,
    (v, key) =>
      ({
  ...
  async function submitDecision() {
    ...
    try {
      ...
      await onDecision(checked, decision, reason);
      setChecked([]);
      setDecisionNotice({
        kind: "ok",
        text: `${count} keputusan verifikasi berhasil disimpan.`,
      });
    } catch (error) {
      setDecisionNotice({
        kind: "error",
    ...
    <article className="card tableCard">
      <div className="miniHead">
        ...
        <div className="verificationHeaderActions">
          {onManageTable && (
            <button
              className="secondary manageTableButton"
          ...
          {canAct ? (
            <div className="verificationActions">
              ...
              <button
                ...
                disabled={!checked.length || processing}
                onClick={() => void submitDecision()}
              >
                {processing ? "Menyimpan..." : `Proses (${checked.length})`}
              </button>
            </div>
          ) : (
      ...
      {decisionNotice && (
        <Notice n={decisionNotice} close={() => setDecisionNotice(null)} />
      )}
      <div className="tableWrap">
        <table>
          <thead>
            <tr>
              ...
              {visibleColumns.includes("flight") && (
                <SortTh
                  label="Flight / Route"
                  sortKey="flight"
                  current={sort}
              ...
              {visibleColumns.includes("ffpNumber") && (
                <th>FFP / Membership Number</th>
              )}
              ...
              {visibleColumns.includes("verifier") && (
                <th>Verifier Organization</th>
              )}
            ...
            {visitors.length ? (
              displayVisitors.map((v) => (
                <tr key={v.id}>
                  ...
                  {visibleColumns.includes("dot") && (
                    <td>{v.travelDate || v.date}</td>
                  )}
                  {visibleColumns.includes("ffpNumber") && (
                    <td>
                      <b>{v.reference || "—"}</b>
                      <small>
                        {v.category.includes("Business")
                          ? "Not required"
                  ...
                  {visibleColumns.includes("verifier") && (
                    <td>{v.verifierOrganization || v.verifier || "—"}</td>
                  )}
                  {visibleColumns.includes("evidence") && (
                    <td>
                      {v.evidenceName || "—"}
                      <small>{v.evidenceType || ""}</small>
                    </td>
                  )}
                  {visibleColumns.includes("price") && (
                    <td>{cash(v.price, v.currency)}</td>
